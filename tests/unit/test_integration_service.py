...
class TestIntegrationService:
    ...
    def integration_service(self, mock_db, mock_encryption):
        ...
        with patch('database.services.integration_service.get_credential_encryption', return_value=mock_encryption):
    ...
    @pytest.mark.asyncio
    async def test_store_integration_config_new(self, integration_service, sample_credentials, sample_health_info):
    ...
    @pytest.mark.asyncio
    async def test_store_integration_config_update_existing(self, integration_service, sample_credentials, sample_health_info):
    ...
    async def test_get_user_integrations(self, integration_service):
        ...
        result_mock.scalars.return_value.all.return_value = [
            Integration(id=uuid.uuid4(), user_id=user_id, provider="aws", encrypted_credentials="encrypted", health_status={}),
            Integration(id=uuid.uuid4(), user_id=user_id, provider="okta", encrypted_credentials="encrypted", health_status={})
        ]
        integration_service.db.execute.return_value = result_mock
    ...
    async def test_update_integration_health(self, integration_service):
        ...
        result = await integration_service.update_integration_health(integration_id, health_data, user_id)

...
class TestCredentialEncryption:
    ...
    def test_encryption_initialization(self):
        ...
        with patch.dict('os.environ', {'CREDENTIAL_MASTER_KEY': 'test-key-32-characters-long-abc123'}):
...
class TestSecurityProperties:
    ...
    def test_different_keys_produce_different_ciphertexts(self):
        ...
        with patch.dict('os.environ', {'CREDENTIAL_MASTER_KEY': 'test-key-1-32-characters-long-abc'}):
            encryption1 = CredentialEncryption()
            encrypted1 = encryption1.encrypt_credentials(test_credentials)
        
        with patch.dict('os.environ', {'CREDENTIAL_MASTER_KEY': 'test-key-2-32-characters-long-def'}):

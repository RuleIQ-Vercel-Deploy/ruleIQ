        ...
        with patch('langgraph_agent.agents.rag_standard.OpenAIEmbeddings') as mock_embeddings:
            ...
            with patch('langgraph_agent.agents.rag_standard.ChatOpenAI') as mock_chat:
                ...
                with patch('langgraph_agent.agents.rag_standard.FAISS') as mock_faiss:
                    ...
                    mock_base_retriever.aget_relevant_documents = AsyncMock(return_value=[])
                    ...
                    with patch('langgraph_agent.agents.rag_standard.MultiQueryRetriever') as mock_multi_query:
                        mock_retriever = Mock()
...
class TestPerformanceImprovement:
    ...
    def test_langchain_components_usage(self):
        ...
        if standard_file.exists():
            ...
            assert "from langchain_text_splitters import RecursiveCharacterTextSplitter" in content
    ...
    def test_simplified_interface(self):
        ...
        public_methods = [
            method for method in dir(StandardizedRAG)

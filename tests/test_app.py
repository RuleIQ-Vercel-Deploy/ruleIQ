...
def create_test_app() -> FastAPI:
    ...
    app.include_router(evidence_collection.router, prefix="/api/evidence-collection", tags=["Evidence Collection"])
    app.include_router(foundation_evidence.router, prefix="/api/foundation-evidence", tags=["Foundation Evidence"])
    app.include_router(ai_assessments.router, prefix="/api", tags=["AI Assessments"])
    app.include_router(ai_optimization.router, prefix="/api/ai-optimization", tags=["AI Optimization"])

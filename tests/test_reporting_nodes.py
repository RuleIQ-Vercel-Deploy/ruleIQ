...
# These will be imported after we create the reporting_nodes module
...
class TestGenerateReportNode:
        ...
        return {
            ...
            "compliance_data": {
                "check_results": {
                    ...
                    "violations": [
                        {"id": "1", "title": "Data Retention Policy"}
                    ]
                },
                "risk_assessment": {
                    "level": "MEDIUM",
    ...
    async def test_generate_compliance_report_success(self, mock_state):
        ...
        # Import will be mocked since module doesn't exist yet
    ...
    async def test_generate_risk_assessment_report(self):
        ...
        with patch('langgraph_agent.nodes.reporting_nodes.generate_report_node') as mock_node:
            ...
            state["report_data"]["content"] = json.dumps(state["compliance_data"]["risk_assessment"])
    ...
    async def test_distribute_report_email_success(self, mock_state_with_report):
        ...
        with patch('langgraph_agent.nodes.reporting_nodes.send_report_email') as mock_email:
            ...
            with patch('langgraph_agent.nodes.reporting_nodes.distribute_report_node') as mock_node:
                ...
                mock_state_with_report["report_data"]["sent_to"] = mock_state_with_report["metadata"]["recipient_emails"]
        ...
        with patch('os.listdir') as mock_listdir:
            ...
            with patch('os.path.getmtime') as mock_getmtime:
                ...
                with patch('os.remove') as mock_remove:
                    with patch('langgraph_agent.nodes.reporting_nodes.cleanup_old_reports_node') as mock_node:
...
class TestReportHelperFunctions:
    ...
    async def test_generate_pdf_report(self, mock_file):
        ...
        with patch('langgraph_agent.nodes.reporting_nodes.generate_pdf_report', new_callable=AsyncMock) as mock_pdf:
    ...
    async def test_send_report_email_with_attachment(self):
        ...
        with patch('smtplib.SMTP') as mock_smtp:
            ...
            with patch('langgraph_agent.nodes.reporting_nodes.send_report_email', new_callable=AsyncMock) as mock_send:
    ...
    async def test_full_reporting_workflow(self):
        ...
        with patch('langgraph_agent.nodes.reporting_nodes.generate_report_node') as mock_gen:
            with patch('langgraph_agent.nodes.reporting_nodes.distribute_report_node') as mock_dist:
                with patch('langgraph_agent.nodes.reporting_nodes.cleanup_old_reports_node') as mock_cleanup:
                    ...
                    assert final_state["cleanup_data"]["deleted_count"] == 3

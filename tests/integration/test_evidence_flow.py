...
class TestEvidenceCollectionFlow:
    ...
    def test_full_evidence_and_reporting_flow(self, mock_gws_integration, sample_business_profile, authenticated_headers, client):
        """
    ...
    @pytest.mark.integration
    def test_scheduled_report_generation(self, sample_business_profile, authenticated_headers, client):
...
class TestErrorHandlingAndResilience:
    ...
    @pytest.mark.integration
    def test_report_generation_with_no_data(self, sample_business_profile, authenticated_headers, client):

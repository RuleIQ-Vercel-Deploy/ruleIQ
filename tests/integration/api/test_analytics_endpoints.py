...
class TestAnalyticsEndpoints:
    ...
    def test_analytics_dashboard_success(self, client, authenticated_headers):
        ...
        with patch('services.ai.analytics_monitor.get_analytics_monitor') as mock_monitor:
            ...
            mock_instance.get_dashboard_data.return_value = {
                ...
                'usage_analytics': {
                    'period': {'start': '2024-01-01T00:00:00', 'end': '2024-01-08T00:00:00', 'days': 7},
                    'total_requests': 1250,
                ...
                'cost_analytics': {
                    'period': {'start': '2024-01-01T00:00:00', 'end': '2024-01-31T00:00:00', 'days': 30},
                    'cost_summary': {
                        'total_cost': 125.75,
    ...
    def test_usage_analytics_endpoint(self, client, authenticated_headers):
        ...
        with patch('services.ai.analytics_monitor.get_analytics_monitor') as mock_monitor:
            ...
            mock_instance.get_usage_analytics.return_value = {
                'period': {'start': '2024-01-01T00:00:00', 'end': '2024-01-15T00:00:00', 'days': 14},
                'total_requests': 2100,
                'framework_usage': {
                    'ISO27001': 750,
                    'GDPR': 650,
            ...
            response = client.get(
                "/api/chat/analytics/usage?days=14",
                headers=authenticated_headers
            )
    ...
    def test_cost_analytics_endpoint(self, client, authenticated_headers):
        ...
        with patch('services.ai.analytics_monitor.get_analytics_monitor') as mock_monitor:
            ...
            response = client.get(
                "/api/chat/analytics/cost?days=30",
                headers=authenticated_headers
            )

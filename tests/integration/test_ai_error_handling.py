...
class TestAIErrorHandling:
    ...
    def test_multiple_ai_service_failures(self, client, authenticated_headers, sample_business_profile):
    ...
    def test_partial_ai_service_degradation(self, client, authenticated_headers, sample_business_profile):
    ...
    def test_ai_error_logging_and_monitoring(self, client, authenticated_headers, sample_business_profile, caplog):
        ...
        with patch('services.ai.assistant.ComplianceAssistant') as mock_assistant:
            ...
            assert any("AI" in record.message or "error" in record.message.lower() 

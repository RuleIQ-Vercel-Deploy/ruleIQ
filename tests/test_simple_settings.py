...
class TestSettings(BaseSettings):
    ...
    annotated_list: Annotated[List[str], BeforeValidator(parse_list_from_string)] = Field(default=["c", "d"])
...
try:
    ...
    print(f"Success: simple_list={settings1.simple_list}, annotated_list={settings1.annotated_list}")
...
try:
    ...
    print(f"Success: simple_list={settings2.simple_list}, annotated_list={settings2.annotated_list}")
except Exception as e:
    print(f"Failed: {e}")
...
try:
    ...
    print(f"Success: simple_list={settings3.simple_list}, annotated_list={settings3.annotated_list}")
except Exception as e:
    print(f"Failed: {e}")
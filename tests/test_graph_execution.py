...
class TestNodeExecutionOrder:
    ...
    def test_parallel_execution_order(self, graph_test_harness):
        ...
        parallel_nodes = ["check_obligation_1", "check_obligation_2", "check_obligation_3"]
...
class TestGraphIntegration:
    ...
    async def test_full_compliance_workflow(self, graph_test_harness):
        ...
        graph_test_harness.mock_external_service("regulation_api", {
...
def generate_error_scenarios() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"type": "RateLimitError", "retryable": True, "message": "API rate limit exceeded"},
        {"type": "AuthenticationError", "retryable": False, "message": "Invalid credentials"},

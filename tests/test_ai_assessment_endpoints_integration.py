...
class TestAIHelpEndpoint:
    ...
    def test_ai_help_endpoint_integration(self, client, authenticated_headers, sample_business_profile):
...
class TestAIFollowupEndpoint:
    ...
    def test_ai_followup_endpoint_integration(self, client, authenticated_headers, sample_business_profile):
...
class TestAIAnalysisEndpoint:
    ...
    def test_ai_analysis_endpoint_integration(self, client, authenticated_headers, sample_business_profile):
...
class TestAIRecommendationsEndpoint:
    ...
    def test_ai_recommendations_endpoint_integration(self, client, authenticated_headers, sample_business_profile):

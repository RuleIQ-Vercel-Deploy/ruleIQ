...
class TestCheckComplianceStatus:
    ...
    async def test_check_compliance_status_successful(self):
        ...
        with patch('langgraph_agent.nodes.compliance_nodes.get_neo4j_service', new_callable=AsyncMock) as mock_get_service:
...
class TestAssessComplianceRisk:
    ...
    async def test_assess_risk_medium_level(self):
        ...
        state = {
            "compliance_data": {
                "check_results": {
                    "violations": [{"id": str(i)} for i in range(2)]
                }
            }
        }
    ...
    async def test_assess_risk_high_level(self):
        ...
        state = {
            "compliance_data": {
                "check_results": {
                    "violations": [{"id": str(i)} for i in range(3)]
                }
            }
        }
    ...
    async def test_assess_risk_critical_level(self):
        ...
        state = {
            "compliance_data": {
                "check_results": {
                    "violations": [{"id": str(i)} for i in range(4)]
                }
            }
        }
    ...
    async def test_assess_risk_capped_at_100(self):
        ...
        state = {
            "compliance_data": {
                "check_results": {
                    "violations": [{"id": str(i)} for i in range(10)]
                }
            }
        }

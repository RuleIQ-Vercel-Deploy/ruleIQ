...
class TestSMBOwnership:
    ...
    async def test_cannot_access_others_profile(
    ...
    async def test_cannot_update_others_profile(
        self, client, auth_headers, other_auth_headers
    ):
    ...
    async def test_cannot_delete_others_profile(
        self, client, auth_headers, other_auth_headers
    ):
    ...
    async def test_list_only_own_profiles(
        self, client, auth_headers, other_auth_headers
    ):
        ...
        await client.post(
            "/api/v1/business-profiles/", json=profile1_data, headers=auth_headers
        )
        ...
        response = await client.get(
            "/api/v1/business-profiles/list", headers=auth_headers
        )
        ...
        response2 = await client.get(
            "/api/v1/business-profiles/list", headers=other_auth_headers
        )
    ...
    async def test_no_auth_rejected(self, client):
        ...
        response = await client.post(
            "/api/v1/business-profiles/", json={"company_name": "Test"}
        )
        assert response.status_code == 401

...
async def test_mistral_embeddings():
    ...
    try:
        ...
        # Test embedding generation (if API keys available)
        if rag_system.use_mistral_embeddings and rag_system.mistral_client:
            ...
            print(f"   Expected: 1024 dimensions (Mistral standard)")
            ...
            print(f"   Expected: 1536 dimensions (OpenAI text-embedding-3-small)")
        ...
        print(f"   • RAG Features: All enabled")

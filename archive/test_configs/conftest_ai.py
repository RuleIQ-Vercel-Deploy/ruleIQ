...
def ai_test_data():
    ...
    return {
        ...
        "assessment_results": {
            "partial_gdpr": {
                "framework_id": "gdpr",
                "answers": {"q1": "yes", "q2": "no", "q3": "partially"},
...
def mock_frontend_ai_service():
    ...
    mock_service.getQuestionHelp = AsyncMock(
        return_value={
    ...
    mock_service.getFollowUpQuestions = AsyncMock(
        return_value={
            "follow_up_questions": [
                {
                    "id": "mock-q1",
    ...
    mock_service.submitFeedback = AsyncMock(
        return_value={"status": "success", "message": "Feedback received"}
    )

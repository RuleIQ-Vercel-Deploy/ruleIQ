...
def export_archon_data():
    ...
    if versions and versions.get("success"):
        ...
        print(
            f"  Exported {len(export_data['tables']['archon_document_versions'])} versions"
        )
...
if __name__ == "__main__":
    try:
        ...
        print(
            "   mcp__archon__list_tasks(filter_by='project', filter_value='342d657c-fb73-4f71-9b6e-302857319aac', page=1, per_page=5)"
        )
        ...
        print("\n4. Export features:")
        print(
            "   mcp__archon__get_project_features(project_id='342d657c-fb73-4f71-9b6e-302857319aac')"
        )

        print("\n5. Export version history:")
        print(
            "   mcp__archon__list_versions(project_id='342d657c-fb73-4f71-9b6e-302857319aac')"
        )

...
from database.models.integrations import (
    Integration, EvidenceCollection, IntegrationEvidenceItem, 
...
async def get_integration_by_id(integration_id: str, db: AsyncSession, user_id: Optional[str] = None) -> Optional[Integration]:

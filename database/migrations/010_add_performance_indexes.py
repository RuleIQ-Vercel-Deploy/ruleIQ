...
def upgrade():
    ...
    op.create_index(
        'idx_evidence_user_status',
        'evidence_items',
        ['user_id', 'status']
    )
    
    op.create_index(
        'idx_evidence_framework',
        'evidence_items',
        ['framework_id']
    )
    
    op.create_index(
        'idx_evidence_business_profile',
        'evidence_items',
        ['business_profile_id']
    )
    ...
    op.create_index(
        'idx_business_profile_user',
        'business_profiles',
        ['user_id']
    )
    
    op.create_index(
        'idx_business_profile_industry',
        'business_profiles',
        ['industry']
    )
    ...
    op.create_index(
        'idx_framework_category',
        'compliance_frameworks',
        ['category']
    )
    
    op.create_index(
        'idx_framework_active',
        'compliance_frameworks',
        ['is_active']
    )
    ...
    op.create_index(
        'idx_evidence_metadata_evidence',
        'evidence_metadata',
        ['evidence_item_id']
    )

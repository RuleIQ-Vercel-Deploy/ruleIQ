...
vi.mock('@/components/dashboard/charts', () => ({
  ...
  FrameworkBreakdownChart: ({ title }: any) => <div data-testid="framework-breakdown-chart">{title}</div>,
...
describe('AnalyticsPage', () => {
  ...
  it('should render analytics dashboard', () => {
    ...
    expect(screen.getByText('Deep insights into your compliance performance and trends')).toBeInTheDocument()
  })
  ...
  it('should display key metrics cards', () => {
    ...
    expect(screen.getByText('Time to compliance')).toBeInTheDocument()
  ...
  it('should handle framework filter changes', async () => {
    ...
    const frameworkSelect = screen.getByDisplayValue('All Frameworks')
  ...
  it('should switch between tab content', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Compliance Deep Dive')).toBeInTheDocument()
    })
  })

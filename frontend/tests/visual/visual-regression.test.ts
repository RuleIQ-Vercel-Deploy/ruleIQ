...
test.describe('Visual Regression Tests', () => {
  ...
  test.describe('Form States', () => {
    test('login form states should match baseline', async ({ page }) => {
      ...
      // Empty state
      await expect(page.locator('[data-testid="login-form"]')).toHaveScreenshot('login-form-empty.png');
    ...
    test('business profile wizard should match baseline', async ({ page }) => {
      ...
      // Step 1
      await expect(page.locator('[data-testid="profile-wizard"]')).toHaveScreenshot('profile-wizard-step1.png');
      ...
      // Step 2
      await expect(page.locator('[data-testid="profile-wizard"]')).toHaveScreenshot('profile-wizard-step2.png');
    });
  });
  ...
  test.describe('Interactive States', () => {
    ...
    test('dropdown menu states should match baseline', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="industry-options"]')).toHaveScreenshot('dropdown-open.png');
    });
  });
  ...
  test.describe('Loading States', () => {
    test('dashboard loading state should match baseline', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="dashboard-loading"]')).toHaveScreenshot('dashboard-loading.png');
    });
    ...
    test('assessment loading state should match baseline', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="assessments-loading"]')).toHaveScreenshot('assessments-loading.png');
    });

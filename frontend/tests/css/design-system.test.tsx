...
const GridTestComponent = () => (
  <div className="grid gap-8 p-8 m-8">
    <div className="p-4 m-4">8px Grid Item</div>
    <div className="p-16 m-16">16px Grid Item</div>
    <div className="p-24 m-24">24px Grid Item</div>
  </div>
);
...
describe('Design System Tests', () => {
  ...
  describe('8px Grid System Compliance', () => {
    ...
    it('should allow 4px half-step when necessary', () => {
      const { container } = render(
        <div className="p-1 m-1 gap-1" data-testid="half-step">
          4px half-step
        </div>
      );
    ...
    it('should validate grid system in complex layouts', () => {
      const { container } = render(
        <div className="grid grid-cols-3 gap-8 p-16">
          <div className="p-8 m-4">Card 1</div>
          <div className="p-8 m-4">Card 2</div>
          <div className="p-8 m-4">Card 3</div>
        </div>
      );
    ...
    it('should maintain typography hierarchy', () => {
      const { container } = render(
        <article>
          ...
          <h3 className="text-lg font-semibold mb-2">Subsection</h3>
          <p className="text-sm mb-2">Body paragraph</p>
    ...
    it('should use consistent spacing units', () => {
      const { container } = render(
        <div className="space-y-8">
          <div className="p-4 mb-8">Item 1</div>
          <div className="p-8 mt-4">Item 2</div>
        ...
        <section className="py-16 px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md">Card 1</div>
              <div className="bg-white p-8 rounded-lg shadow-md">Card 2</div>
              <div className="bg-white p-8 rounded-lg shadow-md">Card 3</div>
            </div>
          </div>
        </section>
      );
  ...
  describe('Icon System', () => {
    it('should use Lucide icons exclusively', () => {
      const { container } = render(
        <div>
          <svg className="lucide lucide-home w-6 h-6">
            <path d="..." />
          </svg>
          <svg className="lucide lucide-user w-4 h-4">
            <path d="..." />
          </svg>
        </div>
      );

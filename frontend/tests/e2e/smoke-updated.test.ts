...
test.describe('Smoke Tests - Updated', () => {
  ...
  test('should load the registration page', async ({ page }) => {
    ...
    await expect(page.locator('form')).toBeVisible();
    await expect(page.locator('input[placeholder*="Full name"], input[placeholder*="full name"]')).toBeVisible();
    await expect(page.locator('input[type="email"]')).toBeVisible();
    await expect(page.locator('input[type="password"]')).toBeVisible();
    await expect(page.locator('button[type="submit"]')).toBeVisible();
  });
  ...
  test('should have working navigation', async ({ page }) => {
    ...
    const registerLink = page.locator('a[href="/register"], text=Sign up, text=Get Started').first();

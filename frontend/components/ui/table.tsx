...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-neutral-50 [&_tr]:border-b [&_tr]:border-neutral-200", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-neutral-200 transition-colors hover:bg-neutral-50 data-[state=selected]:bg-teal-50",
      className
    )}
    {...props}
  />

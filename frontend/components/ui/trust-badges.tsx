...
export function TrustBadges() {
  return (
    <div className="flex flex-col items-center justify-center gap-4 rounded-lg border border-neutral-200 bg-white p-4 text-neutral-700 sm:flex-row sm:justify-between">
      <Badge icon={<Lock className="h-4 w-4 text-purple-600" />} text="256-bit SSL Encryption" />
      <Badge icon={<ShieldCheck className="h-4 w-4 text-purple-600" />} text="GDPR Compliant" />
      <Badge icon={<ShieldCheck className="h-4 w-4 text-purple-600" />} text="ISO 27001 Certified" />
    </div>
  );
}

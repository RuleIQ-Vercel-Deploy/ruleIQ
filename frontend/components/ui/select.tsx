...
>(({ className, children, error, success, ...props }, ref) => (
  <>
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-10 w-full items-center justify-between rounded-lg border bg-white px-3 py-2 text-sm transition-all duration-200 placeholder:text-neutral-400 disabled:cursor-not-allowed disabled:opacity-50',
        // Default state with new design system
        'border-neutral-200',
        // Focus state with teal accent
        'focus:border-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500/20',
        // Error state

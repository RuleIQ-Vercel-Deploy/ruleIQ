...
export function ProfileWizard({ onComplete, initialData }: ProfileWizardProps) {
  ...
  const validateStep = async (step: number) => {
    switch (step) {
      ...
      case 3:
        return await trigger(["data_types_collected", "data_storage_locations", "third_party_sharing"])
      default:
        return false
    }
  }
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-sm">
          <Caption>Step {currentStep + 1} of {steps.length}</Caption>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                index < steps.length - 1 && "after:content-[''] after:w-full after:h-0.5 after:mx-3",
              ...
              <div className="flex flex-col items-center gap-2">
                <div
                  className={cn(
                    ...
                    isActive && "bg-gold border-gold text-white scale-110",
            ...
            <div className={cn("space-y-6", currentStep !== 0 && "hidden")}>
              ...
              <div className="grid gap-6">
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.website && (
                    <Caption color="error">{errors.website.message}</Caption>
                  )}
                </div>
            ...
            <div className={cn("space-y-6", currentStep !== 1 && "hidden")}>
              ...
              <div className="grid gap-6">
                <div className="space-y-2">
                  ...
                  {errors.industry && (
                    <Caption color="error">{errors.industry.message}</Caption>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.size && (
                    <Caption color="error">{errors.size.message}</Caption>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.country && (
                    <Caption color="error">{errors.country.message}</Caption>
                  )}
                </div>
              </div>
            </div>
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => {
                        ...
                        if (checked) {
                          ...
                          setValue("compliance_frameworks", current.filter(id => id !== framework.id))
                        }
                      }}
                      className="mt-0.5"
                    />
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => {
                          ...
                          if (checked) {
                            ...
                            setValue("data_types_collected", current.filter(id => id !== type.id))
                          }
                        }}
                        className="mt-0.5"
                      />
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => {
                          ...
                          if (checked) {
                            ...
                            setValue("data_storage_locations", current.filter(id => id !== location.id))
                          }
                        }}
                      />
                ...
                <div className="space-y-2">
                  <label className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setValue("third_party_sharing", checked as boolean)}
                    />

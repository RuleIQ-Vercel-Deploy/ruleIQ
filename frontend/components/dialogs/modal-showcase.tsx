    ...
    <div className="space-y-8">
      ...
      <Card className="ruleiq-card">
        <CardHeader>
          ...
          <CardDescription style={{ color: "#6C757D" }}>
            The modal system is built with accessibility in mind, ensuring a seamless user experience.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-2 text-sm" style={{ color: "#F0EAD6" }}>
          <p>
            <strong>Focus Trapping:</strong> When a modal is opened, focus is automatically moved inside and contained
            within it. You can use the <kbd className="bg-oxford-blue/80 p-1 rounded">Tab</kbd> key to navigate between
            interactive elements like buttons and inputs.
          </p>
          <p>
            <strong>Focus Restoration:</strong> Upon closing the modal (either by clicking the 'Cancel' button, the 'X'
            icon, or pressing the <kbd className="bg-oxford-blue/80 p-1 rounded">Esc</kbd> key), focus is automatically
            returned to the element that originally triggered it.
          </p>
          <p>
            <strong>Screen Reader Support:</strong> Proper ARIA attributes are used to announce the modal's role, title,
            and description to screen reader users.
          </p>
        </CardContent>
      </Card>
    </div>

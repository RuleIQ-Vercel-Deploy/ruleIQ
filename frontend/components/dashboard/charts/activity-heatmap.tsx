        ...
        <div className="space-y-2">
          ...
          <div className="mt-4 flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <div className="flex gap-1">
              ...
              <div className="bg-cyan/20 h-3 w-3 rounded-sm" />
              <div className="bg-cyan/40 h-3 w-3 rounded-sm" />
              <div className="bg-cyan/60 h-3 w-3 rounded-sm" />
              <div className="bg-cyan h-3 w-3 rounded-sm" />
            </div>
            <span>More</span>
          </div>
        </div>

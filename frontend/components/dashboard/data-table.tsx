        ...
        <Table>
          <TableHeader>
            <TableRow className="border-b border-border bg-muted/50">
              <TableHead className="px-6 py-4 text-left font-semibold">Assessment</TableHead>
              <TableHead className="px-6 py-4 text-center font-semibold">Status</TableHead>
              <TableHead className="px-6 py-4 text-center font-semibold">Progress</TableHead>
              <TableHead className="px-6 py-4 text-right font-semibold">Date</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {currentData.map((item) => (
              ...
              >
                <TableCell className="px-6 py-4">
                  <div className="font-medium">{item.assessment}</div>
                </TableCell>

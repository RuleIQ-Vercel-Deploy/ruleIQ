...
import { Search, Bell, Sun, Moon, User, Settings, LogOut, Clock, AlertTriangle } from "lucide-react"
        ...
        <div className="flex h-16 items-center px-4 gap-4">
          ...
          <div className="lg:hidden flex items-center space-x-1">
            <Tooltip>
              ...
              <TooltipContent>
                <p>
                  Next audit in {timeUntilAudit.days} days, {timeUntilAudit.hours} hours, {timeUntilAudit.minutes}{" "}
                  minutes
                </p>
              </TooltipContent>
            </Tooltip>

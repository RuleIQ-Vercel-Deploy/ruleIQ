...
export const formStyles = {
  input: "w-full px-3 py-2 rounded-md border border-input bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50",
...
export const trustStyles = {
  badge: "inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-primary/5 text-primary text-xs font-medium border border-primary/10",
  securityIcon: "inline-flex items-center gap-1.5 text-success text-sm",
  certBadge: "inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gold/10 text-gold-dark border border-gold/20 font-medium",
}

// Hero Section Styles
export const heroStyles = {
  container: "flex flex-col items-center justify-center min-h-[85vh] px-6 py-12",
  badge: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gold/20 text-gold-dark text-xs font-semibold uppercase tracking-wider mb-6",
...
export const a11yStyles = {
  ...
  focusable: "focus:not-sr-only focus:absolute focus:inset-x-0 focus:top-0 focus:z-50 focus:bg-background focus:p-4",
}

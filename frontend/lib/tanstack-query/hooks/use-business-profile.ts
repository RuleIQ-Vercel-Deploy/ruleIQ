...
export function useCurrentBusinessProfile(
  options?: BaseQueryOptions<BusinessProfile>
) {
...
export function useCreateBusinessProfile(
  ...
  return useMutation({
    mutationFn: (data: CreateBusinessProfileRequest) => 
      businessProfileService.createProfile(data),
...
export function useUpdateBusinessProfile(
  options?: BaseMutationOptions<BusinessProfile, unknown, { id: string; data: UpdateBusinessProfileRequest }>
) {
  const queryClient = useQueryClient();
...
export function useBusinessProfileCompliance(
  id: string,

  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          helperText:
            'e.g., Consent, Contract, Legal Obligation, Vital Interests, Public Task, Legitimate Interests.',
          type: 'textarea',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: 'textarea',
          placeholder:
            'e.g., Data deletion from production and backup systems, notification to third parties...',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          helperText:
            'e.g., Data Processing Agreements (DPAs), vendor security questionnaires, audits.',
          type: 'textarea',

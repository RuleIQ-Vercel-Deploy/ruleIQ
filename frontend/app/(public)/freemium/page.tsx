...
export default function FreemiumLandingPage() {
  return (
    <div data-testid="freemium-landing" className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50">
      {/* Mobile Layout Indicator for E2E Testing */}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="border-purple-200 bg-purple-100 px-3 py-1 text-sm text-purple-700">
                  FREE SECURITY ASSESSMENT AI-Powered Assessment
                </Badge>
                <h1 className="text-4xl font-bold leading-tight text-gray-900 lg:text-5xl">
                  Discover Your
                  <span className="text-purple-600"> Compliance Gaps</span>
                  in 5 Minutes
                </h1>
          ...
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <div className="pt-4">
              <a
                ...
                className="inline-flex items-center rounded-lg bg-white px-8 py-3 font-semibold text-purple-600 transition-colors hover:bg-gray-100"
              >

...
function generateMockData() {
  return {
    ...
    insights: [
      {
        ...
        description: "Your access control policy hasn't been reviewed in 6 months. Consider updating it to reflect recent organizational changes.",
        priority: "high",
        framework: "ISO 27001"
      },
      {
      ...
      },
      {
        ...
        description: "SSL certificate for api.company.com expires in 14 days. Renew to maintain security compliance.",
        priority: "critical",
    ...
    risks: [
      ...
      { id: "4", name: "Vendor Risk", impact: "medium", likelihood: "medium", category: "Third Party" }
    ],
    task_progress: [
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Tip:</strong> Enable "Edit Mode" to customize your dashboard. 
              You can drag widgets to rearrange, resize them by dragging corners, 
              add new widgets, or remove ones you don't need.
            </AlertDescription>
          </Alert>

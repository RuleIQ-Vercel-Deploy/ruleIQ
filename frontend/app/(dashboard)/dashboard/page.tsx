...
function generateMockRiskData() {
  return [
    ...
    { id: "2", name: "Compliance Violation", impact: "high", likelihood: "low", category: "Compliance" },
    { id: "3", name: "System Downtime", impact: "medium", likelihood: "medium", category: "Operational" },
    ...
    { id: "6", name: "Regulatory Change", impact: "medium", likelihood: "medium", category: "Compliance" }
  ]
}
        ...
        <div className="p-6 space-y-8 bg-surface-base">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            {isLoading ? (
              ...
              <FrameworkBreakdownChart 
                data={dashboardData?.framework_scores 
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            {isLoading ? (
              ...
              <TaskProgressChart 
                data={dashboardData?.task_progress || generateMockTaskData()}
              />
            )}
            ...
            {isLoading ? (
              ...
              <RiskMatrix 
                risks={dashboardData?.risks || generateMockRiskData()}
              />
            )}
            ...
            {isLoading ? (
              ...
              <ActivityHeatmap 
                data={dashboardData?.activity_data || generateMockActivityData()}
              />
            )}
          </div>

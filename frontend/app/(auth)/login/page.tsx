    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[calc(100vh-6rem)]">
          ...
          <div className="flex items-center justify-center lg:justify-end order-1">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="text-sm text-gold hover:text-gold-dark hover:underline"
                      >
                        Forgot password?
                      </Link>
                    </div>
          ...
          <div className="hidden lg:flex lg:items-center lg:justify-start order-2">

...
class DeadCodeAnalyzer:
    ...
    def analyze_python_dead_code(self):
        """Analyze Python files for dead code"""
        print("🔍 Analyzing Python dead code...")
    ...
    def _check_python_file(self, file_path: Path):
        """Check individual Python file for dead code"""
        try:
    ...
    def _analyze_ast(self, tree, file_path, content):
        """Analyze AST for unused code"""
        # Find unused imports
        imports = []
        used_names = set()
    ...
    def _is_function_unused(self, func_node, tree):
        """Check if function is unused"""
        # Skip test functions, decorators, and special methods
    ...
    def _is_class_unused(self, class_node, tree):
        """Check if class is unused"""
        # Skip test classes and exceptions
    ...
    def _check_commented_code(self, content: str, file_path: Path):
    ...
    def _check_celery_remnants(self):
        """Check for Celery-related code that should be removed"""
        celery_patterns = [
    ...
    def analyze_javascript_dead_code(self):
        """Analyze JavaScript/TypeScript files for dead code"""
        print("🔍 Analyzing JavaScript/TypeScript dead code...")
    ...
    def _check_javascript_file(self, file_path: Path):
        """Check individual JavaScript file for dead code"""
        try:
            with open(file_path, 'r') as f:
                content = f.read()
    ...
    def _check_js_commented_code(self, content: str, file_path: Path):
        """Check for commented JavaScript code"""
    ...
    def analyze_config_dead_code(self):
        """Analyze configuration files for unused settings"""
        print("🔍 Analyzing configuration dead code...")
    ...
    def run_vulture_analysis(self):
        """Run vulture for additional Python dead code detection"""
    ...
    def create_cleanup_script(self):
        """Create automated cleanup script for safe removals"""
...
def remove_unused_imports():
    ...
    with open('dead_code_report.json', 'r') as f:
        report = json.load(f)

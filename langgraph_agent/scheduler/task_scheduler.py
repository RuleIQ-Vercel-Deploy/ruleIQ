...
class TaskScheduler:
    ...
    def _setup_checkpointer(self):
        ...
        try:
            ...
            if 'neon.tech' not in db_url:
                logger.warning("Database URL does not appear to be a Neon database. "
    ...
    def _build_graph(self):
        ...
        for node in ["evidence_collector", "compliance_updater", 
                    "report_generator", "notification_sender", "cleanup"]:
            workflow.add_conditional_edges(
                node,

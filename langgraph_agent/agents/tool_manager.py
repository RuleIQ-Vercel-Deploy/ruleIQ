...
class BaseComplianceTool(BaseTool, ABC):
    ...
    async def _safe_execute(self, *args, **kwargs) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                tool_name=self.name, success=True, result=result, execution_time_ms=execution_time
            )
            ...
            return ToolResult(
                tool_name=self.name, success=False, error=str(e), execution_time_ms=execution_time
            )

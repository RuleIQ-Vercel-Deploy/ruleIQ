...
class ErrorHandlerNode:
    ...
    def _classify_error(self, state: EnhancedComplianceState) -> str:
        ...
        if "rate limit" in error_msg or "429" in error_msg or "too many requests" in error_msg:
            ...
            return "network"
        elif "database" in error_msg or "postgres" in error_msg or "neo4j" in error_msg or "connection pool" in error_msg:
            return "database"
        elif "timeout" in error_msg or "timed out" in error_msg or "deadline" in error_msg:
            return "timeout"
        elif "api" in error_msg or "endpoint" in error_msg or "404" in error_msg or "500" in error_msg:
            return "api"
        elif "validation" in error_msg or "invalid" in error_msg or "schema" in error_msg or "type error" in error_msg:
            return "validation"
    ...
    async def _handle_database_error(self, state: EnhancedComplianceState) -> EnhancedComplianceState:
        """
    ...
    async def _handle_validation_error(self, state: EnhancedComplianceState) -> EnhancedComplianceState:
        """
    ...
    async def _handle_timeout_error(self, state: EnhancedComplianceState) -> EnhancedComplianceState:
        """
    ...
    async def _handle_network_error(self, state: EnhancedComplianceState) -> EnhancedComplianceState:
        """

...
class TestStateTenancy:
    ...
    def test_state_creation_requires_company_id(self) -> None:
    ...
    def test_state_isolation_between_companies(self) -> None:
    ...
    def test_state_thread_isolation_within_company(self) -> None:
    ...
    def test_state_user_isolation(self) -> None:
        ...
        state_user_a = create_initial_state(
            company_id=company_id, user_input="User A message", thread_id=thread_id, user_id=user_a
        )

        state_user_b = create_initial_state(
            company_id=company_id, user_input="User B message", thread_id=thread_id, user_id=user_b
        )
...
class TestToolTenancy:
    ...
    @pytest.mark.asyncio
    async def test_tool_manager_company_id_injection(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_tool_execution_company_id_validation(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_parallel_tool_execution_tenancy(self) -> None:
        ...
        tool_configs_a = [
            {
                ...
                "kwargs": {"business_profile": {"industry": "retail"}, "frameworks": ["GDPR"]},
            }
        ]
        ...
        tool_configs_b = [
            {
                "tool": "compliance_analysis",
                "kwargs": {"business_profile": {"industry": "finance"}, "frameworks": ["PCI_DSS"]},
            }
        ]
    ...
    @pytest.mark.asyncio
    async def test_tool_stats_isolation(self) -> None:
...
class TestGraphTenancy:
    ...
    @pytest.mark.asyncio
    async def test_graph_invocation_company_isolation(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_graph_config_tenancy(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stream_graph_tenancy(self) -> None:
...
class TestErrorTenancy:
    ...
    def test_safe_fallback_response_tenancy(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_tool_error_fallback_tenancy(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_graph_error_tenancy(self) -> None:
...
class TestDataIsolation:
    ...
    def test_conversation_history_isolation(self) -> None:
    ...
    def test_tool_results_isolation(self) -> None:
...
class TestCrossCompanySecurityValidation:
    ...
    def test_company_id_required_everywhere(self) -> None:
    ...
    def test_thread_id_isolation_enforcement(self) -> None:
...
class TestAuditTrails:
    ...
    def test_state_metadata_includes_tenancy_info(self) -> None:
        ...
        state = create_initial_state(
            company_id=company_id, user_input="Audit test", thread_id=thread_id, user_id=user_id
        )
    ...
    def test_error_audit_trails(self) -> None:

...
class TestToolCreation:
    ...
    def test_compliance_analysis_tool_creation(self) -> None:
    ...
    def test_document_retrieval_tool_creation(self) -> None:
    ...
    def test_evidence_collection_tool_creation(self) -> None:
    ...
    def test_report_generation_tool_creation(self) -> None:
    ...
    def test_all_tools_have_required_langchain_methods(self) -> None:
...
class TestToolManager:
    ...
    def test_tool_manager_initialization(self) -> None:
    ...
    def test_tool_manager_list_tools(self) -> None:
    ...
    def test_tool_manager_get_tool(self) -> None:
    ...
    def test_tool_manager_priority_filtering(self) -> None:
...
class TestToolExecution:
    ...
    async def test_compliance_analysis_tool_execution(self) -> None:
    ...
    async def test_document_retrieval_tool_execution(self) -> None:
    ...
    async def test_evidence_collection_tool_execution(self) -> None:
    ...
    async def test_report_generation_tool_execution(self) -> None:
        """Test ReportGenerationTool execution."""
        tool = ReportGenerationTool()

        result = await tool._execute(
            company_id="test_company_123", report_type="compliance_assessment", frameworks=["GDPR"]
        )
...
class TestToolManagerExecution:
    ...
    async def test_execute_tool_chain(self) -> None:
    ...
    async def test_execute_parallel_tools(self) -> None:
...
class TestToolStats:
    ...
    def test_tool_stats_initialization(self) -> None:
    ...
    def test_tool_stats_individual_tool(self) -> None:
...
class TestErrorHandling:
    ...
    async def test_tool_execution_exception(self) -> None:
        ...
        async def failing_execute(*args, **kwargs) -> NoReturn:

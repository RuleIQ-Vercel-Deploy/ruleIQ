...
class TestNodeFunctions:
    ...
    @pytest.mark.asyncio
    async def test_router_node_gdpr_keyword(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_router_node_obligation_keyword(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_router_node_evidence_keyword(self) -> None:
        """Test router routes evidence keywords to evidence collector."""
        state = create_initial_state(
            company_id=uuid4(), user_input="I need to collect compliance evidence documents"
        )
    ...
    @pytest.mark.asyncio
    async def test_router_node_legal_keyword(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_router_node_default_route(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_router_node_empty_messages(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_compliance_analyzer_node(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_obligation_finder_node(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_evidence_collector_node(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_legal_reviewer_node(self) -> None:
...
class TestGraphCreation:
    ...
    def test_create_graph_compilation_ready(self) -> None:
...
class TestGraphInvocation:
    ...
    async def test_invoke_graph_basic_flow(self) -> None:
    ...
    async def test_invoke_graph_with_thread_id(self) -> None:
    ...
    async def test_invoke_graph_error_handling(self) -> None:
        ...
        company_id = uuid4()
        result = await invoke_graph(
            compiled_graph=mock_compiled_graph, company_id=company_id, user_input="Test input"
        )
    ...
    async def test_invoke_graph_slo_monitoring(self) -> None:
        ...
        with patch("langgraph_agent.graph.app.logger") as mock_logger:
            result = await invoke_graph(
                compiled_graph=mock_compiled_graph, company_id=uuid4(), user_input="Test input"
            )
    ...
    async def test_stream_graph_basic_flow(self) -> None:
        ...
        async for chunk in stream_graph(
            compiled_graph=mock_compiled_graph, company_id=company_id, user_input="Test streaming"
        ):
            chunks.append(chunk)
    ...
    async def test_stream_graph_error_handling(self) -> None:
        ...
        async for chunk in stream_graph(
            compiled_graph=mock_compiled_graph, company_id=company_id, user_input="Test error"
        ):
            chunks.append(chunk)
...
class TestIntegrationFlow:
    ...
    async def test_full_router_to_analyzer_flow(self) -> None:
        """Test full flow from router to compliance analyzer."""
        state = create_initial_state(
            company_id=uuid4(), user_input="What GDPR requirements apply to my retail business?"
        )
    ...
    async def test_full_router_to_obligation_finder_flow(self) -> None:
        """Test full flow from router to obligation finder."""
        state = create_initial_state(
            company_id=uuid4(), user_input="What obligations must I implement for data processing?"
        )
    ...
    async def test_state_consistency_through_flow(self) -> None:

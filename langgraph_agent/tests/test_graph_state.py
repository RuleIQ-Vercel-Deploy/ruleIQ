...
from langgraph_agent.core.models import SafeFallbackResponse, GraphMessage


class TestCreateInitialState:
    """Test initial state creation."""
    
    def test_create_basic_initial_state(self):
    ...
    def test_create_initial_state_with_full_params(self):
...
class TestGetStateSummary:
    ...
    def test_get_state_summary_with_route(self):

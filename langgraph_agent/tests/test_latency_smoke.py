...
from langgraph_agent.evals.metrics import LatencyEvaluator, LatencyMetrics, run_latency_smoke_test
...
class LatencyTestHelper:
    ...
    def generate_test_inputs() -> List[Dict[str, Any]]:
        ...
        test_inputs = [
            ...
            {"company_id": uuid4(), "user_input": "Do I need a DPO?", "autonomy_level": 2},
        ]
        return test_inputs
...
class TestGraphLatency:
    ...
    async def test_graph_invocation_latency_single(self) -> None:
        ...
        result = await invoke_graph(
            compiled_graph=mock_graph, company_id=company_id, user_input="Test GDPR question"
        )
    ...
    async def test_graph_invocation_latency_batch(self) -> None:
    ...
    async def test_streaming_latency_first_token(self) -> None:
        ...
        async for chunk in stream_graph(
            compiled_graph=mock_graph, company_id=company_id, user_input="Test streaming"
        ):
    ...
    async def test_concurrent_graph_executions(self) -> None:
...
class TestToolLatency:
    ...
    async def test_tool_manager_latency(self) -> None:
        ...
        tool_tests = [
            {
                ...
                "kwargs": {"business_profile": {"industry": "tech"}, "frameworks": ["GDPR"]},
            },
            {
                "tool_name": "document_retrieval",
                "kwargs": {"query": "GDPR template", "framework": "GDPR", "doc_type": "template"},
            },
    ...
    async def test_parallel_tool_execution_latency(self) -> None:
        ...
        tool_configs = [
            ...
            },
            {
                ...
                "kwargs": {"query": "GDPR", "framework": "GDPR", "doc_type": "template"},
            },
    ...
    async def test_tool_chain_latency(self) -> None:
        ...
        tool_sequence = [
            ...
            {"tool": "evidence_collection", "kwargs": {"frameworks": ["GDPR"]}},
            {
                ...
                "kwargs": {"report_type": "compliance_assessment", "frameworks": ["GDPR"]},
            },
        ]
...
class TestLatencyEvaluator:
    ...
    def test_latency_evaluator_basic(self) -> None:
    ...
    def test_latency_evaluator_slo_violation(self) -> None:
    ...
    def test_latency_evaluator_evaluation_result(self) -> None:
...
class TestSmokeTestRunner:
    ...
    async def test_run_latency_smoke_test(self) -> None:
    ...
    async def test_smoke_test_with_failures(self) -> None:
...
class TestRealisticLatencyBenchmarks:
    ...
    async def test_end_to_end_latency_benchmark(self) -> None:
...
def test_slo_constants_reasonable() -> None:

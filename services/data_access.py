...
class DataAccess:
    ...
    @staticmethod
    def ensure_owner(db: Session, model: Any, resource_id: UUID, user: User, resource_name: str = "resource") -> Any:
        """
    ...
    @staticmethod
    def delete_owned(db: Session, model: Any, resource_id: UUID, user: User, resource_name: str = "resource") -> bool:
        """
    ...
    async def delete_owned_async(
        ...
        """
        resource = await DataAccess.ensure_owner_async(db, model, resource_id, user, resource_name)

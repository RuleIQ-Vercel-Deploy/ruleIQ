...
class AuthorizationService:
    ...
    DEFAULT_PERMISSIONS = {
        ...
        'admin': [
            'user:*', 'assessment:*', 'policy:*', 'evidence:*',
            'report:*', 'settings:*', 'audit:read'
        ],
        'manager': [
            'user:read', 'assessment:*', 'policy:*', 'evidence:*',
            'report:*', 'settings:read'
        ],
        'user': [
            'user:read:own', 'assessment:*:own', 'policy:read',
            'evidence:*:own', 'report:read:own'
        ],
        'viewer': [
            'assessment:read', 'policy:read', 'report:read'
        ]
    }

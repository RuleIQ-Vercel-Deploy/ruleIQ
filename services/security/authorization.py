...
class AuthorizationService:
    ...
    DEFAULT_PERMISSIONS = {
        "super_admin": ["*:*"],
        "admin": ["user:*", "assessment:*", "policy:*", "evidence:*", "report:*", "settings:*", "audit:read"],
        "manager": ["user:read", "assessment:*", "policy:*", "evidence:*", "report:*", "settings:read"],
        "user": ["user:read:own", "assessment:*:own", "policy:read", "evidence:*:own", "report:read:own"],
    ...
    async def _check_delegated_permission(
        self, user: User, resource_type: str, permission_type: str, resource_id: Optional[str] = None
    ) -> bool:
    ...
    async def revoke_permission(
        self, user_id: str, resource_type: str, permission_type: str, resource_id: Optional[str] = None
    ) -> None:

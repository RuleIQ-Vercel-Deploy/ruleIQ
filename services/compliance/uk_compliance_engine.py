...
class UKComplianceManifest:
    ...
    def _calculate_automation_potential(self, obligation_data: Dict) -> float:
        ...
        if any(keyword in obligation_data.get("description", "").lower() 
    ...
    def get_obligations_by_regulation(self, regulation_id: str) -> List[ComplianceObligation]:
        ...
        return [
            ...
            if ob.regulation_ref == regulation_id
        ]
...
class UKComplianceAssessmentEngine:
    ...
    async def assess_compliance(
        ...
        assessment_results["overall_score"] = self._calculate_overall_score(assessment_results["results"])
        assessment_results["risk_rating"] = self._determine_risk_rating(assessment_results["overall_score"])

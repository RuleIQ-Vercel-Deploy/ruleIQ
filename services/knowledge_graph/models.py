...
class GraphNode:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {'id': self.id, 'type': self.type.value if isinstance(self.type, NodeType) else self.type, 'properties': self.properties, 'metadata': self.metadata}
...
class GraphRelationship:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {'id': self.id, 'type': self.type.value if isinstance(self.type, RelationshipType) else self.type, 'source_id': self.source_id, 'target_id': self.target_id, 'properties': self.properties, 'metadata': self.metadata}
...
class GraphPath:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {'nodes': [n.to_dict() for n in self.nodes], 'relationships': [r.to_dict() for r in self.relationships], 'total_weight': self.total_weight, 'length': len(self.nodes)}
...
class GraphSnapshot:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {'id': self.id, 'timestamp': self.timestamp.isoformat(), 'node_count': len(self.nodes), 'relationship_count': len(self.relationships), 'metadata': self.metadata}

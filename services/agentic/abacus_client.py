    ...
    def _initialize_credentials(self) -> None:
        ...
        try:
            ...
            if not all([self._api_key, self._deployment_id, self._deployment_token]):
                ...
                raise ValueError(
                     f"Missing required Abacus AI credentials in Doppler: {', '.join(missing)}. Please run: scripts/setup_doppler_secrets.sh", )logger.info("Abacus AI credentials loaded successfully from Doppler")

...
from .analytics_monitor import get_analytics_monitor, MetricEvent, MetricType as AnalyticsMetricType
...
class AIModelTester:
    ...
    def setup_model_comparison(self, 
        ...
        logger.info(f"Set up model comparison: {control_model} vs {treatment_model} (exp: {experiment_id})")
...
class PromptOptimizationTester:
    ...
    def setup_prompt_test(self,
                         original_prompt: str,
                         optimized_prompt: str,
                         task_type: str,
                         metric: ComplianceMetric = ComplianceMetric.TASK_COMPLETION_TIME) -> str:
        """
        ...
        config = ExperimentConfig(
            ...
            metric_type=MetricType.CONTINUOUS if metric in [
    ...
    def record_prompt_result(self,
                           experiment_id: str,
                           variant: str,
                           user_id: str,
                           metric_value: float,
                           task_context: Optional[Dict[str, Any]] = None) -> bool:
        """
...
class ComplianceEffectivenessTester:
    ...
    def setup_methodology_test(self,
                             methodology_name: str,
                             control_approach: str,
                             treatment_approach: str,
                             metric: ComplianceMetric = ComplianceMetric.COMPLIANCE_SCORE_IMPROVEMENT) -> str:
        """
        ...
        logger.info(f"Set up compliance methodology test: {methodology_name} (exp: {experiment_id})")
        return experiment_id
    
    def record_compliance_outcome(self,
                                experiment_id: str,
                                variant: str,
                                organization_id: str,
...
class ABTestingManager:
    ...
    def start_ai_model_experiment(self,
                                control_model: str,
                                treatment_model: str,
                                metric: ComplianceMetric = ComplianceMetric.ASSESSMENT_ACCURACY) -> str:
    ...
    def start_prompt_experiment(self,
                              original_prompt: str,
                              optimized_prompt: str,
                              task_type: str) -> str:
    ...
    def start_compliance_experiment(self,
                                  methodology_name: str,
                                  control_approach: str,
    ...
    def _estimate_additional_samples_needed(self, current_power: float, effect_size: float) -> int:
        ...
        current_total = sum(
            ...
            for summary in [self.framework.get_experiment_summary(exp_id) 
                          for exp_list in self.active_experiments.values() 
...
def record_ai_performance(experiment_id: str, model_name: str, 
                         user_id: str, accuracy_score: float) -> bool:

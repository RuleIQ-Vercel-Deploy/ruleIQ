...
class ServiceHealthMonitor:
    ...
    async def _perform_health_check(self, service_name: str, health_check: HealthCheck) -> None:
        ...
        try:
            ...
            await self._update_health_metrics(service_name, {"healthy": False, "error": str(e)}, response_time)

    async def _update_health_metrics(self, service_name: str, result: Dict[str, Any], response_time: float) -> None:
    ...
    async def _update_performance_metrics(self, service_name: str, response_time: float, success: bool) -> None:
    ...
    def _store_health_history(self, service_name: str, metrics: HealthMetrics, result: Dict[str, Any]) -> None:
    ...
    def get_all_health_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "issues": {"unhealthy_services": unhealthy_services, "degraded_services": degraded_services},
        ...
        for service_name, metrics in self.services.items():
            ...
            if len(recent_history) >= 10:
                ...
                trend_direction = (
                    ...
                    else "declining" if second_half_success < first_half_success else "stable"
                )
                trends[service_name] = {

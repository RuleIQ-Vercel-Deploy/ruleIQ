...
"""
    ...
    def get_assessment_instruction(
        self, framework: FrameworkType, business_profile: Dict[str, Any], user_persona: Optional[str] = None, **kwargs
    ) -> str:
    ...
    def get_evidence_instruction(self, framework: FrameworkType, business_profile: Dict[str, Any], **kwargs) -> str:
        """Get evidence-specific instruction"""
        return self.get_instruction_for_task(
            InstructionType.EVIDENCE, framework=framework, business_profile=business_profile, **kwargs
        )

    def get_chat_instruction(
        self, business_profile: Optional[Dict[str, Any]] = None, user_persona: Optional[str] = None, **kwargs
    ) -> str:
        """Get chat-specific instruction"""
        return self.get_instruction_for_task(
            InstructionType.CHAT, business_profile=business_profile, user_persona=user_persona, **kwargs
        )

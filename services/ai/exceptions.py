...
class AITimeoutException(AIServiceException):
    ...
    def __init__(
        self, timeout_seconds: float, service_name: str = "AI Service", context: Optional[Dict[str, Any]] = None
    ) -> None:
        message = (f"{service_name} request timed out after {timeout_seconds} seconds",)
        super().__init__(message=message, service_name=service_name, error_code="AI_TIMEOUT", context=context)
...
class AIQuotaExceededException(AIServiceException):
    ...
    def __init__(
        self, quota_type: str = "requests", service_name: str = "AI Service", context: Optional[Dict[str, Any]] = None
    ) -> None:
        message = f"{service_name} {quota_type} quota exceeded"
        super().__init__(message=message, service_name=service_name, error_code="AI_QUOTA_EXCEEDED", context=context)
...
class AIModelException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(message=message, service_name=service_name, error_code="AI_MODEL_ERROR", context=context)
...
class AIContentFilterException(AIServiceException):
    ...
    def __init__(
        self, filter_reason: str, service_name: str = "AI Service", context: Optional[Dict[str, Any]] = None
    ) -> None:
        message = f"{service_name} content filtered: {filter_reason}"
        super().__init__(message=message, service_name=service_name, error_code="AI_CONTENT_FILTERED", context=context)
...
class AIParsingException(BusinessLogicException):
    ...
    def __init__(
        self, response_text: str, expected_format: str, parsing_error: str, context: Optional[Dict[str, Any]] = None
    ) -> None:
...
class AIValidationException(BusinessLogicException):
    ...
    def __init__(
        self, validation_errors: list, response_data: Dict[str, Any], context: Optional[Dict[str, Any]] = None
    ) -> None:
...
class ModelUnavailableException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(message=message, service_name=service_name, error_code="MODEL_UNAVAILABLE", context=context)
        self.model_name = model_name
        self.reason = reason
...
class ModelTimeoutException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(message=message, service_name=service_name, error_code="MODEL_TIMEOUT", context=context)
        self.model_name = model_name
        self.timeout_seconds = timeout_seconds
...
class ModelOverloadedException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(message=message, service_name=service_name, error_code="MODEL_OVERLOADED", context=context)
        self.model_name = model_name
...
class ModelConfigurationException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(message=message, service_name=service_name, error_code="MODEL_CONFIG_ERROR", context=context)
        self.model_name = model_name
...
class CircuitBreakerException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(message=message, service_name=service_name, error_code="CIRCUIT_BREAKER_OPEN", context=context)
...
class SchemaValidationException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(
            message=error_summary, service_name=service_name, error_code="SCHEMA_VALIDATION_FAILED", context=context
        )
...
class ResponseProcessingException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, service_name=service_name, error_code="RESPONSE_PROCESSING_FAILED", context=context
        )
        self.response_type = response_type
...
class ModelRetryExhaustedException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(message=message, service_name=service_name, error_code="RETRY_EXHAUSTED", context=context)
        self.model_name = model_name
...
def map_gemini_error(
    ...
    if error_type and error_type.name in GEMINI_ERROR_MAPPING:
        ...
        if exception_class == ModelTimeoutException:
            return ModelTimeoutException(
                model_name=model_name, timeout_seconds=30.0, service_name="Google Gemini", context=context
            )
        elif exception_class == ModelOverloadedException:
            return ModelOverloadedException(model_name=model_name, service_name="Google Gemini", context=context)
        elif exception_class == ModelUnavailableException:
            return ModelUnavailableException(
                model_name=model_name, reason=error_message, service_name="Google Gemini", context=context
            )
        elif exception_class == ModelConfigurationException:
            return ModelConfigurationException(
                model_name=model_name, config_error=error_message, service_name="Google Gemini", context=context
            )
        else:
            return exception_class(
                message=error_message, service_name="Google Gemini", error_code=error_type.name, context=context
            )
    ...
    return AIServiceException(
        message=error_message, service_name="Google Gemini", error_code="UNKNOWN_ERROR", context=context
    )

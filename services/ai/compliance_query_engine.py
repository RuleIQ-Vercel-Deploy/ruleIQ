...
class ComplianceQueryEngine:
    ...
    async def get_applicable_regulations(self, business_profile: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
    ...
    async def get_regulation_risk_analysis(self, regulation_id: str) -> Dict[str, Any]:
        ...
        async with self.driver.session() as session:
            ...
            return {
                ...
                "enforcement_frequency": reg.get("risk_metadata", {}).get("enforcement_frequency"),

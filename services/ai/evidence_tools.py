...
class EvidenceMapperTool(BaseTool):
                ...
                "properties": {
                    "evidence_requirements": {
                        ...
                        "items": {
                            "type": "object",
                            "properties": {
                                "title": {"type": "string", "description": "Title of the evidence requirement"},
                                "description": {
                                    "type": "string",
                    ...
                    "resource_requirements": {
                        ...
                        "properties": {
                            ...
                            "estimated_effort": {"type": "string", "description": "Estimated effort required"},
    ...
    async def execute(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> ToolResult:
        ...
        try:
            ...
            logger.info("Evidence mapping completed: %s evidence requirements mapped" % len(processed_evidence))
            return ToolResult(
                success=True,
                data=result_data,
                metadata={
...
class ComplianceScoringTool(BaseTool):
            ...
            "parameters": {
                ...
                "properties": {
                    "assessment_results": {
                        "type": "object",
                        "properties": {
                            "framework": {"type": "string", "description": "Compliance framework assessed"},
                            "total_controls": {"type": "number", "description": "Total number of controls assessed"},
                            "compliant_controls": {
                                "type": "number",
                    ...
                    "context_factors": {
                        "type": "object",
                        "properties": {
                            "industry": {"type": "string", "description": "Industry sector for context"},
                            "business_size": {
                                "type": "string",
                            ...
                            "assessment_scope": {"type": "string", "description": "Scope of the assessment"},
                        },
                    },
                },
    ...
    async def execute(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> ToolResult:
        ...
        try:
            ...
            benchmark_comparison = self._generate_benchmark_comparison(weighted_score, context_factors)
            result_data = {
            ...
            logger.info(
                "Compliance scoring completed: %s% overall score, %s maturity" % (weighted_score, maturity_level)
            )
            return ToolResult(
                success=True,
                data=result_data,

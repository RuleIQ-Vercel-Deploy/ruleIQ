...
class EvidenceMapperTool(BaseTool):
    ...
    async def execute(
        ...
        try:
            ...
            logger.info(
                f"Evidence mapping completed: {len(processed_evidence)} evidence requirements mapped"
            )
...
class ComplianceScoringTool(BaseTool):
    ...
    async def execute(
        ...
        try:
            ...
            logger.info(
                f"Compliance scoring completed: {weighted_score:.1f}% overall score, {maturity_level} maturity"
            )

...
class Neo4jConnection:
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_initialized"):
            ...
            logger.info("[Neo4jConnection] NEO4J_URI from env: %s" % os.getenv("NEO4J_URI"))
            logger.info("[Neo4jConnection] NEO4J_USER from env: %s" % os.getenv("NEO4J_USER"))
            logger.info("[Neo4jConnection] NEO4J_PASSWORD from env: %s" % os.getenv("NEO4J_PASSWORD"))

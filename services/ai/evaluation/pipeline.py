...
class EvaluationPipeline:
    ...
    async def _execute_with_retry(self, evaluator: Callable, task: EvaluationTask, 
...
class RegressionDetector:
    ...
    def detect(self, baseline: Dict[str, float], 
    ...
    def analyze_trend(self, history: List[Dict[str, Any]], 
...
class BaselineComparator:
    ...
    def compare(self, baseline: Dict[str, Dict[str, float]], 
...
class PipelineOrchestrator:
    ...
    async def run_evaluation(self, tasks: List[EvaluationTask]) -> Dict[str, Any]:
        ...
        if self.baseline:
            ...
            # Detect regressions
            current_metrics = {k: v["mean"] for k, v in aggregated.items() 
                              if isinstance(v, dict) and "mean" in v}
            baseline_metrics = {k: v["mean"] for k, v in self.baseline.items()
                               if isinstance(v, dict) and "mean" in v}

...
class TestDocumentProcessor(unittest.TestCase):
        ...
        with patch('builtins.open', mock_file):
            with patch('os.path.abspath') as mock_abspath:
                with patch('os.path.normpath') as mock_normpath:
                    ...
                    self.assertEqual(docs[0].doc_id, "doc1")
                    self.assertEqual(docs[0].content, "Test content 1")
                    self.assertEqual(docs[0].source_meta.origin, "test_source")
    ...
    def test_validate_document_valid(self):
        ...
        self.assertTrue(self.processor.validate_document(doc))
    ...
    def test_validate_document_invalid(self):
        ...
        self.assertFalse(self.processor.validate_document(doc))
        
        # Test with non-GoldenDoc object
        self.assertFalse(self.processor.validate_document({"doc_id": "test"}))
...
class TestChunkingService(unittest.TestCase):
    ...
    def test_chunk_document_single_chunk(self):
        ...
        self.assertEqual(chunks[0].chunk_id, "test_doc_chunk_0")
    ...
    def test_chunk_document_multiple_chunks(self):
        ...
        self.assertEqual(chunks[0].chunk_id, "test_doc_chunk_0")
        self.assertEqual(chunks[1].chunk_id, "test_doc_chunk_1")
    ...
    def test_chunk_document_with_overlap(self):
        ...
        for chunk in chunks:
            ...
            self.assertTrue(hasattr(chunk, 'chunk_index'))
...
class TestGoldenDatasetIngestion(unittest.TestCase):
    ...
    def test_load_and_validate_documents(self):
        ...
        self.assertEqual(docs[0].doc_id, "doc1")
        self.assertEqual(docs[1].doc_id, "doc2")
    ...
    def test_ensure_vector_index(self):
        ...
        self.assertIn("golden_chunk_embeddings", query)
    ...
    def test_write_document_to_neo4j(self):
        ...
        self.assertIn("MERGE (d:GoldenDocument", query)
        self.assertEqual(kwargs['doc_id'], "test_doc")
        self.assertEqual(kwargs['content'], "Test content")
        self.assertEqual(kwargs['source'], "test_source")
    ...
    def test_write_chunks_to_neo4j(self):
        ...
        self.assertEqual(chunks_created, 2)
        ...
        self.assertIn("CREATE (c:GoldenChunk", first_call[0][0])
        self.assertEqual(first_call[1]['chunk_id'], "c1")
        self.assertEqual(first_call[1]['content'], "Chunk 1")
    ...
    def test_process_single_document_error(self):
        ...
        self.assertIn("Chunking failed", result['error'])
    ...
    def test_ingest_from_file_success(self):
        ...
        self.assertEqual(result['chunks_created'], 4)
        self.assertEqual(result['embeddings_generated'], 4)
    ...
    def test_ingest_from_file_no_documents(self):
        ...
        self.assertIn("No valid documents", result['errors'][0])
    ...
    def test_ingest_from_file_partial_failure(self):
        ...
        self.assertIn("Processing failed", result['errors'][0])
    ...
    def test_search_similar(self):
        ...
        self.assertEqual(results[1]['chunk_id'], 'chunk2')
        self.assertEqual(results[1]['score'], 0.85)
        
        # Verify the query was called with correct parameters
        self.mock_session.run.assert_called_once()
        query_call = self.mock_session.run.call_args
        self.assertEqual(query_call[1]['limit'], 2)
        self.assertEqual(query_call[1]['query_embedding'], mock_embedding)
...
class TestNeo4jConnectionFixed(unittest.TestCase):
    ...
    def test_close_connection(self):
        ...
        self.assertIsNone(conn._driver)

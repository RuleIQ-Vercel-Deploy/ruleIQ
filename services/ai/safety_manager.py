...
class AdvancedSafetyManager:
    ...
    def __init__(self):
        ...
        self.compliance_keywords = [
            'gdpr', 'iso27001', 'sox', 'hipaa', 'pci dss', 'regulation',
            'compliance', 'audit', 'control', 'policy', 'procedure'
        ]
    ...
    def _initialize_default_profiles(self):
        ...
        self.safety_profiles['enterprise'] = SafetyProfile(
            ...
            blocked_keywords=[
                ...
                'unlawful', 'fraudulent', 'ignore', 'skip', 'avoid'
            ]
        )
    ...
    def get_safety_settings(self, 
                          ...
                          context: Optional[Dict[str, Any]] = None) -> Dict[HarmCategory, HarmBlockThreshold]:
        """
    ...
    def evaluate_content_safety(self,
        ...
        if profile.require_regulatory_context and content_type in [
            ContentType.REGULATORY_INTERPRETATION, ContentType.COMPLIANCE_ADVICE
        ]:
    ...
    def _has_regulatory_context(self, content: str) -> bool:
        ...
        compliance_mentions = sum(1 for keyword in self.compliance_keywords 
                                if keyword in content_lower)
        
        # Look for regulatory structure
        regulatory_indicators = [
            'regulation', 'requirement', 'compliance', 'standard',
            'framework', 'guideline', 'mandate', 'obligation'
        ]
        
        regulatory_mentions = sum(1 for indicator in regulatory_indicators 
    ...
    def _update_metrics(self, record: SafetyDecisionRecord):
        ...
        # Update averages
        total_confidence = (self.metrics.avg_confidence_score * (self.metrics.total_decisions - 1) + 
        ...
        low_confidence_count = sum(1 for r in self.decision_history[-1000:] 
    ...
    def get_safety_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_decisions": len([r for r in self.decision_history 

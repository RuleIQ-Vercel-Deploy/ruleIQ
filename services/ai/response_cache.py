...
class AIResponseCache:
    ...
    async def cache_response(
        ...
        try:
            ...
            if success:
                ...
                logger.debug(f"Cached response with TTL {ttl}s for content type {content_type.value}")
    ...
    def _generate_cache_key(self, prompt: str, context: Optional[Dict[str, Any]] = None) -> str:
        ...
        if context:
            ...
            stable_context = {
                ...
                'org_size': context.get('business_context', {}).get('employee_count', 0) // 100 * 100,  # Round to nearest 100
    ...
    def _classify_content_type(self, response: str, context: Optional[Dict[str, Any]] = None) -> ContentType:
        ...
        elif any(keyword in response_lower for keyword in ['policy', 'procedure', 'governance', 'compliance requirement']):

    ...
    async def _generate_evidence_requirements(
        ...
        framework_requirements = {
            'ISO27001': [
                ...
                {'control_id': 'A.12.6.1', 'evidence_type': 'vulnerability_assessment', 'title': 'Vulnerability Management'},
                {'control_id': 'A.7.2.2', 'evidence_type': 'training_record', 'title': 'Information Security Awareness'},
                {'control_id': 'A.16.1.1', 'evidence_type': 'policy_document', 'title': 'Incident Management Procedures'}
            ],
            'GDPR': [

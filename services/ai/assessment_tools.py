...
class GapAnalysisTool(BaseTool):
    ...
    async def execute(
        ...
        try:
            ...
            logger.info(
                f"Gap analysis completed: {len(processed_gaps)} gaps identified with {overall_risk} overall risk"
            )
...
class RecommendationGenerationTool(BaseTool):
    ...
    async def execute(
        ...
        try:
            ...
            logger.info(
                f"Recommendation generation completed: {len(processed_recommendations)} recommendations generated"
            )

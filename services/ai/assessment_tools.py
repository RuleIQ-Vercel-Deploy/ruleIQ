...
class GapAnalysisTool(BaseTool):
                ...
                "properties": {
                    "gaps": {
                        ...
                        "items": {
                            ...
                            "required": ["section", "severity", "description", "impact", "current_state", "target_state"]
                        }
                    },
                    "overall_risk_level": {
                        "type": "string",
    ...
    async def execute(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> ToolResult:
        ...
        try:
            ...
            # Process gaps into structured format
            processed_gaps = []
            ...
            logger.info(f"Gap analysis completed: {len(processed_gaps)} gaps identified with {overall_risk} overall risk")
    ...
    def _calculate_priority(self, severity: str, index: int) -> int:
        ...
        # Decrease priority slightly for later items to maintain order
...
class RecommendationGenerationTool(BaseTool):
                ...
                "properties": {
                    "recommendations": {
                        ...
                        "items": {
                            ...
                            "required": ["title", "description", "priority", "implementation_effort", "cost_impact", "timeline"]
                        }
                    },
    ...
    async def execute(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> ToolResult:
        ...
        try:
            ...
            logger.info(f"Recommendation generation completed: {len(processed_recommendations)} recommendations generated")
            ...
            return ToolResult(
                ...
                metadata={
                    ...
                    "high_priority_count": sum(1 for r in processed_recommendations if r["priority"] in ["critical", "high"])
                }
            )

...
from services.ai.ab_testing_utils import (
...
def test_statistical_framework():
    ...
    print(f"✅ Recorded {len(control_scores)} control and {len(treatment_scores)} treatment observations")
    ...
    print(f"   Duration: {summary['data_summary']['start_time']} to {summary['data_summary']['end_time']}")

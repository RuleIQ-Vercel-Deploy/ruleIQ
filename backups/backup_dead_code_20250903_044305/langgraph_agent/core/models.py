...
class ComplianceFramework(str, Enum): GDPR = 'GDPR'
    UK_GDPR = 'UK_GDPR'
    DPA_2018 = 'DPA_2018'
    PECR = 'PECR'
    ISO_27001 = 'ISO_27001'
...
class BusinessSector(str, Enum): RETAIL = 'retail'
...
class RiskLevel(str, Enum): LOW = 'low'
    MEDIUM = 'medium'
    HIGH = 'high'
    CRITICAL = 'critical'

class EvidenceType(str, Enum): POLICY_DOCUMENT = 'policy_document'
...
class ComplianceProfile(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
    company_id: UUID
...
class Obligation(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
...
class EvidenceItem(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
...
class LegalReviewTicket(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
...
class SafeFallbackResponse(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
...
class GraphMessage(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
...
class RouteDecision(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
...
class ComplianceAnalysisRequest(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
    company_id: UUID
...
class ComplianceAnalysisResponse(BaseModel): model_config = ConfigDict(str_strip_whitespace=True, validate_assignment=True, extra='forbid')
    company_id: UUID
...
def get_model_schemas() -> Dict[str, Dict[str, Any]]: return {'ComplianceProfile': ComplianceProfile.model_json_schema(), 'Obligation': Obligation.model_json_schema(), 'EvidenceItem': EvidenceItem.model_json_schema(), 'LegalReviewTicket': LegalReviewTicket.model_json_schema(), 'SafeFallbackResponse': SafeFallbackResponse.model_json_schema(), 'GraphMessage': GraphMessage.model_json_schema(), 'RouteDecision': RouteDecision.model_json_schema()}

def get_compliance_profile_schema() -> Dict[str, Any]: return ComplianceProfile.model_json_schema()

def get_obligation_schema() -> Dict[str, Any]: return Obligation.model_json_schema()

def get_evidence_schema() -> Dict[str, Any]: return EvidenceItem.model_json_schema()

def get_legal_review_schema() -> Dict[str, Any]: return LegalReviewTicket.model_json_schema()

def get_safe_fallback_schema() -> Dict[str, Any]: return SafeFallbackResponse.model_json_schema()
...
@pytest.fixture
def compliance_assistant(): from sqlalchemy.ext.asyncio import AsyncSession
...
class TestAIOptimizationPerformance:
    ...
    def test_circuit_breaker_overhead(self, compliance_assistant, performance_config): circuit_breaker = compliance_assistant.circuit_breaker
    ...
    @pytest.mark.asyncio
    async def test_cost_optimization_simulation(self, compliance_assistant): # Simulate different task types and measure model selection
        task_scenarios = [
            ...
            with patch.object(
                ...
                with patch.object(
                    ...
                    async def mock_response():
                        for i in range(10): yield f"Analysis chunk {i}"

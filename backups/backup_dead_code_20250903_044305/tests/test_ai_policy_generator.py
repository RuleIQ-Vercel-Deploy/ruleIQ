...
class TestPolicyGenerationService:
    ...
    @pytest.fixture
    def sample_uk_gdpr_framework(self): return ComplianceFramework(
            id="test-uk-gdpr-id",
            name="ICO_GDPR_UK",
    ...
    @pytest.fixture
    def sample_business_context(self): return BusinessContext(
    ...
    @pytest.fixture
    def policy_generation_request(self, sample_business_context): return PolicyGenerationRequest(
    ...
    def test_policy_generator_initialization(self): generator = PolicyGenerator()
    ...
    def test_circuit_breaker_configuration(self): circuit_breaker = AICircuitBreaker()
    ...
    def test_policy_generation_both_providers_fail(
        ...
        with patch("services.ai.policy_generator.GoogleAIClient") as mock_google, patch(
            "services.ai.policy_generator.OpenAIClient"
        ) as mock_openai:
    ...
    def test_template_processor_iso27001_integration(self): processor = TemplateProcessor()
    ...
    def test_policy_customization_levels(
    ...
    def test_policy_validation_uk_specific(self, sample_uk_gdpr_framework): generator = PolicyGenerator()
    ...
    def test_cost_optimization_caching(
        ...
        with patch("services.ai.policy_generator.GoogleAIClient") as mock_google:
            ...
            assert (
                mock_google.return_value.generate_policy.call_count == 1
            )  # No additional call

    def test_policy_refinement_iterative(self, sample_uk_gdpr_framework): generator = PolicyGenerator()
...
class TestPolicyGeneratorAPIIntegration:
    ...
    def test_generate_policy_endpoint(self, client, db_session): # Pre-populate UK GDPR framework
    ...
    def test_refine_policy_endpoint(self, client): request_data = {
    ...
    def test_policy_templates_endpoint(self, client): response = client.get("/api/v1/ai/policy-templates")
...
class TestPolicyGeneratorPerformance:
    ...
    def test_concurrent_policy_generation(
        ...
        with patch("services.ai.policy_generator.GoogleAIClient") as mock_google:
            ...
            assert all(
                "Concurrent test policy" in result.policy_content for result in results
            )

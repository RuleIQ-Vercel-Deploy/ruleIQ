...
class LangSmithConfig:
    ...
    @staticmethod
    def is_tracing_enabled() ->bool: return os.getenv('LANGCHAIN_TRACING_V2', 'false').lower() == 'true'

    @staticmethod
    def get_api_key() ->Optional[str]: return os.getenv('LANGCHAIN_API_KEY')

    @staticmethod
    def get_project_name() ->str: return os.getenv('LANGCHAIN_PROJECT', 'ruleiq-assessment')

    @staticmethod
    def get_endpoint() ->str: return os.getenv('LANGCHAIN_ENDPOINT',
            'https://api.smith.langchain.com')

    @staticmethod
    def validate_configuration() ->bool: Validate LangSmith configuration.
    ...
    @staticmethod
    def add_custom_tags(tags: List[str], **custom_tags) ->List[str]: Add custom tags for enhanced filtering in LangSmith UI.
    ...
    @staticmethod
    def _extract_metadata(args: tuple, kwargs: dict) ->Dict[str, Any]: Extract metadata from function arguments.
    ...
    @staticmethod
    def _generate_tags(operation: str, metadata: Dict[str, Any]) ->List[str]: Generate tags from operation and metadata.
...
def with_langsmith_tracing(operation: str, include_input: bool=True,
    ...
    def decorator(func) ->Any:
        ...
        async def wrapper(*args, **kwargs) ->Any:
            if not LangSmithConfig.is_tracing_enabled(): return await func(*args, **kwargs)

...
async function captureAllPages() {
  ...
  try {
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/02-login-page.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/03-register-page.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/04-signup-page.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/05-dashboard.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/06-assessments-page.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/07-new-assessment.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/08-business-profile.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/09-settings.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/10-pricing.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/11-compliance-wizard.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/12-chat-interface.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/13-reports.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/14-policies.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/15-evidence.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/16-analytics.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/17-team-settings.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/18-billing-settings.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/19-integrations.png`,
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: `${screenshotsDir}/20-404-error.png`,
      fullPage: true,
    });

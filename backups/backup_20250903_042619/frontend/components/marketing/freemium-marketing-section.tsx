        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl space-y-8 text-center">
            <div className="space-y-4">
              <Badge className="bg-teal-600 px-4 py-1 text-white">🚀 Free AI Assessment</Badge>
            ...
            {!showInlineCapture && (
              <Button
                ...
                className="bg-teal-600 px-8 py-3 text-lg text-white hover:bg-teal-700"
              >
            ...
            <div className="lg:pl-8">
              {showInlineCapture ? (
                ...
                <div className="text-center">
                  <Button
                    onClick={() => (window.location.href = '/freemium')}
                    className="bg-teal-600 px-8 py-4 text-lg text-white hover:bg-teal-700"
                    size="lg"
                  >
                    Start Free Assessment
                    <ArrowRight className="ml-2 h-5 w-5" />

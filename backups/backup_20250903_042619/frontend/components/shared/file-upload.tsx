          ...
          {isDragReject ? (
            ...
            <>
              ...
              <div className="space-y-1">
                <Body>{isDragActive ? 'Drop files here' : 'Drag & drop files here'}</Body>
                <Caption color="muted">or click to select files</Caption>
              </div>
              <div className="space-y-1">
                <Caption color="muted">Accepted: {acceptedTypes.join(', ').toUpperCase()}</Caption>
                <Caption color="muted">
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {file.error && (
                      <Caption color="error" className="mt-1">
                        {file.error}
                      </Caption>
                    )}
                  </div>

...
test.describe('Business Profile Management', () => {
  ...
  test.describe('Profile Setup Wizard', () => {
    ...
    test('should allow navigation between wizard steps', async ({ page }) => {
      ...
      await profileHelpers.fillField(
        '[data-testid="company-name-input"]',
        BUSINESS_PROFILES.TECH_STARTUP.companyName,
      );
      await page.selectOption(
        '[data-testid="industry-select"]',
        BUSINESS_PROFILES.TECH_STARTUP.industry,
      );
      await page.selectOption(
        '[data-testid="employee-count-select"]',
        BUSINESS_PROFILES.TECH_STARTUP.employeeCount,
      );
      await profileHelpers.clickAndWait('[data-testid="next-button"]');
  ...
  test.describe('Profile Management', () => {
    ...
    test('should view existing business profile', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="industry"]')).toContainText(
        BUSINESS_PROFILES.TECH_STARTUP.industry,
      );
      await expect(page.locator('[data-testid="employee-count"]')).toContainText(
        BUSINESS_PROFILES.TECH_STARTUP.employeeCount,
      );
    });
    ...
    test('should handle multiple business profiles', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="profile-list"]')).toContainText(
        BUSINESS_PROFILES.TECH_STARTUP.companyName,
      );
      await expect(page.locator('[data-testid="profile-list"]')).toContainText(
        BUSINESS_PROFILES.FINANCIAL_SERVICES.companyName,
      );
    });
  ...
  test.describe('Data Types and Compliance', () => {
    test('should configure data types and show relevant frameworks', async ({ page }) => {
      ...
      await profileHelpers.fillField(
        '[data-testid="company-name-input"]',
        BUSINESS_PROFILES.HEALTHCARE.companyName,
      );
      await page.selectOption(
        '[data-testid="industry-select"]',
        BUSINESS_PROFILES.HEALTHCARE.industry,
      );
      await page.selectOption(
        '[data-testid="employee-count-select"]',
        BUSINESS_PROFILES.HEALTHCARE.employeeCount,
      );
      await profileHelpers.clickAndWait('[data-testid="next-button"]');
    ...
    test('should show industry-specific recommendations', async ({ page }) => {
      ...
      await page.selectOption(
        '[data-testid="industry-select"]',
        BUSINESS_PROFILES.FINANCIAL_SERVICES.industry,
      );
      await page.selectOption(
        '[data-testid="employee-count-select"]',
        BUSINESS_PROFILES.FINANCIAL_SERVICES.employeeCount,
      );
      await profileHelpers.clickAndWait('[data-testid="next-button"]');
  ...
  test.describe('Profile Validation', () => {
    ...
    test('should require at least one data type selection', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="data-types-error"]')).toContainText(

...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    activity: [
      {
        id: 1,
        action: 'Sync failed: API token expired',
  ...
  },
  {
    ...
    logo: Gitlab,
    description:
      'Connect your GitLab repositories to automate evidence collection from your CI/CD pipelines.',
    isConnected: false,
  ...
  },
  {
    ...
    logo: Folder,
    description:
      'Integrate with SharePoint to automatically sync compliance documents and policies.',
    isConnected: false,

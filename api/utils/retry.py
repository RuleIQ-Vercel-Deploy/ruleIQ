...
network_retry = retry(
    max_attempts=3, base_delay=1.0, max_delay=30.0, exceptions=(ConnectionError, TimeoutError, OSError)
)
api_retry = retry(
    max_attempts=5,
    base_delay=2.0,
...
database_retry = retry(max_attempts=3, base_delay=0.5, max_delay=10.0, exceptions=(ConnectionError, OSError))

...
async def refine_policy(request: PolicyRefinementRequest, db: Session = Depends(get_db)):
    """
...
async def validate_policy(policy_content: str, framework_id: str, db: Session = Depends(get_db)):
    """

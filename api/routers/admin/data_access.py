...
async def grant_data_access(
    ...
    try:
        ...
        return DataAccessResponse(
            ...
            business_profile_id=str(data_access.business_profile_id) if data_access.business_profile_id else None,
...
async def list_access_levels(
    ...
    return {
        "access_levels": [
            ...
            {"level": "organization_data", "description": "User can access data within their organization"},
...
async def audit_data_access(
    ...
    return {
        "summary": {"total_access_records": total_access_records, "active_access_records": active_access_records},
        "access_distribution": [{"access_type": item.access_type, "count": item.count} for item in access_distribution],
    }

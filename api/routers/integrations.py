...
@router.delete('/{provider}', summary='Disconnect integration', status_code=status.HTTP_204_NO_CONTENT, response_model=None)
...
async def get_integration_logs(
    ...
    return {
        'integration_id': integrationId, 
        'logs': [
            {'timestamp': '2024-01-15T15:30:00Z', 'level': 'info', 'message': 'Sync completed successfully', 'details': {'records': 150}}, 

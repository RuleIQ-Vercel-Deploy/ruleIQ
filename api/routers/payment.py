...
async def cancel_subscription(
    ...
    return {
        ...
        "effective_date": datetime.now(timezone.utc).isoformat() if immediate else "end_of_billing_period",
        "reason": reason,
...
async def get_upcoming_invoice(
    ...
    return {
        "invoice": {
            ...
            "line_items": [{"description": "Pro Plan Monthly Subscription", "amount": 99.0, "quantity": 1}],
            "subtotal": 99.0,
            "tax": 0.0,
            "total": 99.0,
        },
...
async def get_subscription_limits(
    ...
    return {
        "plan": "Pro",
        "limits": {
            "ai_assessments": {"limit": 100, "used": 45, "remaining": 55, "resets_at": "2024-02-01T00:00:00Z"},
            "policy_generations": {"limit": 50, "used": 12, "remaining": 38, "resets_at": "2024-02-01T00:00:00Z"},
            "team_members": {"limit": 10, "used": 3, "remaining": 7},
            "storage_gb": {"limit": 100, "used": 25.5, "remaining": 74.5},
            "api_calls": {"limit": 10000, "used": 3567, "remaining": 6433, "resets_at": "2024-02-01T00:00:00Z"},
        },
        "overage_charges": {
            "enabled": False,

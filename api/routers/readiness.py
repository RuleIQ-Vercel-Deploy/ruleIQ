...
async def get_readiness_assessment(
    ...
    if not framework_id:
        ...
        if not framework:
            raise HTTPException(status_code=HTTP_BAD_REQUEST, detail="No compliance frameworks available")
...
async def get_assessment_history(
    framework_id: Optional[UUID] = None, limit: int = 10, current_user: User = Depends(get_current_active_user)
) -> Any:
        ...
        "phases": [
            {
                ...
                "name": "Foundation",
                "duration": "2 months",
                "tasks": ["Complete initial assessment", "Document current processes", "Identify key stakeholders"],
            },
            {
                "phase": 2,
                "name": "Implementation",
                "duration": "3 months",
                "tasks": ["Implement required policies", "Deploy technical controls", "Train staff"],
            },
            {
                "phase": 3,
                "name": "Validation",
...
async def quick_readiness_assessment(
    ...
    return {
        ...
        "recommended_frameworks": [
            {"framework": "GDPR", "priority": "High", "reason": "Operating in EU region", "estimated_readiness": 40},
            {
                "framework": "ISO 27001",
                "priority": "Medium",
        ...
        "immediate_actions": ["Appoint Data Protection Officer", "Create privacy policy", "Implement cookie consent"],
...
async def get_industry_benchmarks(
    ...
    return {
        "industry": industry,
        "company_size": size,
        "benchmarks": {"average_readiness": 72, "top_quartile": 85, "your_position": "above_average", "percentile": 65},
        ...
        "common_gaps": ["Data retention policies", "Third-party risk management", "Incident response procedures"],
        "best_practices": ["Regular compliance audits", "Automated evidence collection", "Continuous monitoring"],

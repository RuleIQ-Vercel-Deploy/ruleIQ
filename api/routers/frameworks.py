...
async def list_frameworks(
    current_user: UserWithRoles = Depends(require_permission("user_list")), db: AsyncSession = Depends(get_async_db)
) -> Any:
...
async def get_framework(
    ...
    if not has_access:
        raise HTTPException(
            status_code=HTTP_FORBIDDEN, detail="Access denied: You don't have permission to access this framework"
        )

...
async def get_database_performance(
    ...
    try:
        ...
        if db_metrics.avg_query_time < 0.05 and db_metrics.connection_pool_utilization < 0.7:
            rating = "excellent"
        elif db_metrics.avg_query_time < 0.1 and db_metrics.connection_pool_utilization < 0.8:
            rating = "good"
...
async def get_api_performance(
    ...
    try:
        ...
        if api_metrics.avg_response_time < 0.1 and api_metrics.p95_response_time < 0.5:
            ...
            rating = "good"
        elif api_metrics.avg_response_time < 0.5 and api_metrics.p95_response_time < 2.0:
            rating = "warning"
        else:
            rating = "critical"

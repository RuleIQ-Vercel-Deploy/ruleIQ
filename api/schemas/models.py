...
class BusinessProfileCreate(BaseModel):
    company_name: str = Field(..., min_length=2, max_length=100)
    """Class for BusinessProfileCreate"""
    industry: str = Field(..., min_length=2, max_length=50)
    employee_count: int = Field(..., ge=1, le=1000000)
    annual_revenue: Optional[str] = Field(None, pattern='^(Under £\\\\d+[MK]|£\\\\d+[MK]-£\\\\d+[MK]|Over £\\\\d+[MK])$')
    country: str = Field(default='United Kingdom', max_length=50)
...
class BusinessProfileUpdate(BaseModel):
    ...
    """Class for BusinessProfileUpdate"""
...
class BusinessProfileResponse(BusinessProfileBase):
    id: UUID
    """Class for BusinessProfileResponse"""
    user_id: UUID
    created_at: datetime
    updated_at: datetime
...
class ComplianceFrameworkResponse(BaseModel):
    id: UUID
    """Class for ComplianceFrameworkResponse"""
    name: str
    description: str
    category: str
...
class FrameworkRecommendation(BaseModel):
    ...
    """Class for FrameworkRecommendation"""
...
class PolicyGenerateRequest(BaseModel):
    ...
    """Class for PolicyGenerateRequest"""
...
class GeneratedPolicyResponse(BaseModel):
    id: UUID
    """Class for GeneratedPolicyResponse"""
    policy_name: str
    content: str
    status: str
    created_at: datetime
...
class EvidenceDashboardResponse(BaseModel):
    total_items: int
    """Class for EvidenceDashboardResponse"""
...
class AssessmentSessionCreate(BaseModel):
    ...
    """Class for AssessmentSessionCreate"""
    session_type: str = 'compliance_scoping'

class AssessmentSessionResponse(BaseModel):
    id: UUID
    """Class for AssessmentSessionResponse"""
    user_id: UUID
...
class AssessmentResponseUpdate(BaseModel):
    ...
    """Class for AssessmentResponseUpdate"""
...
class ImplementationPlanCreate(BaseModel):
    framework_id: UUID
    """Class for ImplementationPlanCreate"""
...
class ImplementationPlanResponse(BaseModel):
    id: UUID
    """Class for ImplementationPlanResponse"""
    user_id: UUID
...
class ImplementationTaskUpdate(BaseModel):
    ...
    """Class for ImplementationTaskUpdate"""
...
class ReadinessAssessmentResponse(BaseModel):
    id: UUID
    """Class for ReadinessAssessmentResponse"""
    user_id: UUID
    framework_id: UUID
    business_profile_id: UUID
    overall_score: float

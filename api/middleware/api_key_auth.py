...
class APIKeyAuthMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        try:
            ...
            if not is_valid:
                ...
                raise HTTPException(status_code=status.HTTP_401_UNAUTHORIZED, detail=error or "Invalid API key")
    ...
    async def _validate_api_key(self, api_key: str, request: Request) -> Tuple[bool, Optional[dict], Optional[str]]:

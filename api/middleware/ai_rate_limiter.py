...
class AIRateLimiter:
    ...
    async def check_rate_limit(self, user_id: str) -> Tuple[bool, int]:
        ...
        async with self._lock:
            ...
            # Reset burst allowance every hour
            if current_time - self.burst_reset_time[user_id] > 3600:
...
ai_followup_rate_limit = create_ai_rate_limit_dependency(
    ai_followup_limiter, "followup"
)
ai_analysis_rate_limit = create_ai_rate_limit_dependency(
    ai_analysis_limiter, "analysis"
)

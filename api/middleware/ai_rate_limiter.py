...
def create_ai_rate_limit_dependency(limiter: AIRateLimiter, operation_name: str) -> Any:
    ...
    async def ai_rate_limit_check(request: Request, current_user: User = Depends(get_current_active_user)) -> None:
...
ai_recommendations_rate_limit = create_ai_rate_limit_dependency(ai_recommendations_limiter, "recommendations")
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "rate_limit_percentage": (
                self.rate_limited_requests / self.total_requests * 100 if self.total_requests > 0 else 0
            ),

    ...
    for (let week = 0; week < 12; week++) {
      for (let day = 0; day < 7; day++) {
        data.push({
          ...
          activity: ['Policy Update', 'Assessment', 'Evidence Upload'][
          ...
          <Tabs defaultValue="overview" className="space-y-4">
              ...
              <div className="grid gap-6 lg:grid-cols-3">
                {isLoading ? (
                  ...
                  <>
                    ...
                    />
                    <ActivityHeatmap
                      data={analyticsData.activity_data
                        .slice(0, 84)
                        .map((item: { week: string; day: number; value: number }) => ({
            ...
            <TabsContent value="activity" className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">Activity analytics coming soon...</p>
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>

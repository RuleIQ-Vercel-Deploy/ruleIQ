...
def analyze_failures(test_output):
    ...
    for line in lines:
        ...
        if any(keyword in line for keyword in [
            ...
            'asyncio', 'sqlalchemy', 'pytest', 'fixture'
        ]):
...
def categorize_test_issues(failures, errors):
    ...
    for test in all_failed_tests:
        ...
        elif any(keyword in test.lower() for keyword in ['ai_', 'cached_content', 'cache_strategy']):
...
def generate_fix_strategy(categories):
    ...
    if categories['database_issues']:
        ...
        strategy['fix_approaches']['database_issues'] = 'Fix database connections and async handling'
    ...
    if categories['authentication_issues']:
        ...
        strategy['fix_approaches']['authentication_issues'] = 'Fix authentication and user management'

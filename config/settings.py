    ...
    celery_broker_url: str = Field(
        default_factory=lambda: (
            'redis://localhost:6380/1' if os.getenv('TESTING', '').lower() == 'true'
                ...
                SecretKeys.CELERY_BROKER_URL if SECRETS_VAULT_AVAILABLE else 'celery_broker_url',
                'CELERY_BROKER_URL'
    ...
    celery_result_backend: str = Field(
        default_factory=lambda: (
            'redis://localhost:6380/2' if os.getenv('TESTING', '').lower() == 'true'
                ...
                SecretKeys.CELERY_RESULT_BACKEND if SECRETS_VAULT_AVAILABLE else 'celery_result_backend',

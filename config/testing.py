...
class TestingConfig(BaseConfig):
    ...
    GOOGLE_API_KEY: Optional[str] = Field(default="test-google-key", env="GOOGLE_API_KEY")
    ANTHROPIC_API_KEY: Optional[str] = Field(default="test-anthropic-key", env="ANTHROPIC_API_KEY")

...
class BaseConfig(BaseSettings):
    ...
    JWT_EXPIRATION_DELTA_SECONDS: int = Field(
        default=86400, description="JWT expiration time in seconds"  # 24 hours
    )
    ...
    CLAUDE_MODEL: str = Field(
        default="claude-3-opus-20240229", description="Claude model"
    )
    ...
    def get_ai_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "google": {
                ...
                "ai_api_key": self.GOOGLE_AI_API_KEY,
            },
            "anthropic": {

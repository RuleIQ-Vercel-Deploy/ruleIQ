...
class PerformanceProfiler:
    ...
    def profile_operation(self, operation: str, context: Optional[Dict[str, Any]] = None):
        ...
        self._process.memory_info().rss / 1024 / 1024  # MB
...
class APIPerformanceMonitor:
    ...
    def _update_endpoint_stats(self, endpoint: str, method: str) -> None:
    ...
    return {
        ...
        "database_performance": {
            ...
            "total_db_operations": len(
                [k for k in global_profiler.get_all_stats().keys() if k.startswith("db.")]
            ),
        },
        "system_metrics": {

...
def with_langsmith_tracing(operation: str, include_input: bool = True, include_output: bool = True):
    """
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            with tracing_v2_enabled(
                project_name=LangSmithConfig.get_project_name(), tags=tags, metadata=metadata
            ):

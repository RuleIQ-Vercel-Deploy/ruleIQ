...
class DevelopmentConfig(BaseConfig):
    ...
    def __init__(self, **kwargs):
        ...
        defaults = {
            "SECRET_KEY": kwargs.get("SECRET_KEY", "dev-secret-key-change-in-production"),
            "JWT_SECRET_KEY": kwargs.get("JWT_SECRET_KEY", "dev-jwt-secret-key-change-in-production"),
            "DATABASE_URL": kwargs.get("DATABASE_URL", "postgresql://localhost/ruleiq_dev"),

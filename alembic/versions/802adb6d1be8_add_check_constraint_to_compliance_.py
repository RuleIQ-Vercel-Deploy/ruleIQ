...
def upgrade():
    ...
    sa.CheckConstraint("version ~ '^[0-9]+\\.[0-9]+(\\.[0-9]+)?$'", name=op.f('ck_compliance_frameworks_ck_compliance_frameworks_version_format')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_integrations_user_id_users')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['business_profile_id'], ['business_profiles.id'], name=op.f('fk_assessment_sessions_business_profile_id_business_profiles')),
    ...
    sa.ForeignKeyConstraint(['business_profile_id'], ['business_profiles.id'], name=op.f('fk_chat_conversations_business_profile_id_business_profiles')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['business_profile_id'], ['business_profiles.id'], name=op.f('fk_evidence_business_profile_id_business_profiles')),
    sa.ForeignKeyConstraint(['framework_id'], ['compliance_frameworks.id'], name=op.f('fk_evidence_framework_id_compliance_frameworks')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['integration_id'], ['integrations.id'], name=op.f('fk_evidence_collections_integration_id_integrations')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_evidence_collections_user_id_users')),
    ...
    op.create_index('idx_collection_framework', 'evidence_collections', ['framework_id'], unique=False)
    op.create_index('idx_collection_integration', 'evidence_collections', ['integration_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['business_profile_id'], ['business_profiles.id'], name=op.f('fk_evidence_items_business_profile_id_business_profiles')),
    sa.ForeignKeyConstraint(['framework_id'], ['compliance_frameworks.id'], name=op.f('fk_evidence_items_framework_id_compliance_frameworks')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_evidence_items_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_evidence_items'))
    )
    op.create_table('generated_policies',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['business_profil'], ['business_profiles.id'], name=op.f('fk_generated_policies_business_profil_business_profiles')),
    sa.ForeignKeyConstraint(['framework_id'], ['compliance_frameworks.id'], name=op.f('fk_generated_policies_framework_id_compliance_frameworks')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_generated_policies_user_id_users')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['business_profile_id'], ['business_profiles.id'], name=op.f('fk_implementation_plans_business_profile_id_business_profiles')),
    sa.ForeignKeyConstraint(['framework_id'], ['compliance_frameworks.id'], name=op.f('fk_implementation_plans_framework_id_compliance_frameworks')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_implementation_plans_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_implementation_plans'))
    )
    op.create_table('integration_health_logs',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('integration_id', sa.UUID(), nullable=False),
    sa.Column('status', sa.String(length=20), nullable=False),
    ...
    sa.ForeignKeyConstraint(['integration_id'], ['integrations.id'], name=op.f('fk_integration_health_logs_integration_id_integrations')),
    ...
    op.create_index('idx_health_integration', 'integration_health_logs', ['integration_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['business_profile_id'], ['business_profiles.id'], name=op.f('fk_policies_business_profile_id_business_profiles')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['business_profile_id'], ['business_profiles.id'], name=op.f('fk_readiness_assessments_business_profile_id_business_profiles')),
    sa.ForeignKeyConstraint(['framework_id'], ['compliance_frameworks.id'], name=op.f('fk_readiness_assessments_framework_id_compliance_frameworks')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_readiness_assessments_user_id_users')),
    ...
    sa.ForeignKeyConstraint(['business_profile_id'], ['business_profiles.id'], name=op.f('fk_report_schedules_business_profile_id_business_profiles')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_report_schedules_user_id_users')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['session_id'], ['assessment_sessions.id'], name=op.f('fk_assessment_questions_session_id_assessment_sessions')),
    ...
    op.create_table('integration_evidence_items',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['collection_id'], ['evidence_collections.id'], name=op.f('fk_integration_evidence_items_collection_id_evidence_collections')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_integration_evidence_items'))
    )
    op.create_index('idx_evidence_collected', 'integration_evidence_items', ['collected_at'], unique=False)
    op.create_index('idx_evidence_collection', 'integration_evidence_items', ['collection_id'], unique=False)
    op.create_index('idx_evidence_controls', 'integration_evidence_items', [sa.literal_column('compliance_controls jsonb_path_ops')], unique=False, postgresql_using='gin')
    op.create_index('idx_evidence_resource', 'integration_evidence_items', ['resource_id'], unique=False)
    op.create_index('idx_evidence_source', 'integration_evidence_items', ['source_system'], unique=False)
    op.create_index('idx_evidence_type', 'integration_evidence_items', ['evidence_type'], unique=False)
    op.create_table('evidence_audit_logs',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['collection_id'], ['evidence_collections.id'], name=op.f('fk_evidence_audit_logs_collection_id_evidence_collections')),
    sa.ForeignKeyConstraint(['evidence_item_id'], ['integration_evidence_items.id'], name=op.f('fk_evidence_audit_logs_evidence_item_id_integration_evidence_items')),
    sa.ForeignKeyConstraint(['integration_id'], ['integrations.id'], name=op.f('fk_evidence_audit_logs_integration_id_integrations')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_evidence_audit_logs_user_id_users')),
    ...
    op.create_index('idx_audit_resource', 'evidence_audit_logs', ['resource_type', 'resource_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index('idx_evidence_controls', table_name='integration_evidence_items', postgresql_using='gin')

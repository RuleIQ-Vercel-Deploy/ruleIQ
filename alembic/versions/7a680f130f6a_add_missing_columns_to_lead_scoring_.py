...
def upgrade():
    ...
    op.add_column('lead_scoring_events', sa.Column('event_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
    op.add_column('lead_scoring_events', sa.Column('session_context', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
    op.add_column('lead_scoring_events', sa.Column('event_duration', sa.Integer(), nullable=True))
    op.add_column('lead_scoring_events', sa.Column('ip_address', sa.String(length=45), nullable=True))

...
def upgrade():
    ...
    op.create_index(
        "idx_evidence_items_business_profile_id", "evidence_items", ["business_profile_id"]
    )
    ...
    op.create_index(
        "idx_evidence_items_user_framework", "evidence_items", ["user_id", "framework_id"]
    )
    ...
    op.create_index(
        "idx_evidence_items_framework_status", "evidence_items", ["framework_id", "status"]
    )
    ...
    op.create_index(
        "idx_chat_conversations_business_profile_id", "chat_conversations", ["business_profile_id"]
    )

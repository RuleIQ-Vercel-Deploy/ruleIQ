...
class NodeExecutionTracker:
    ...
    def complete_node(self, exec_id: str, status: NodeStatus=NodeStatus.SUCCESS, error: Optional[str]=None) -> None:
    ...
    @contextmanager
    def track_node(self, node_name: str, metadata: Dict[str, Any]=None) -> Generator[Any, None, None]:
...
class LangGraphMetricsCollector:
    ...
    async def track_node_execution(self, node_name: str, execution_time: float, status: str, workflow_id: Optional[str]=None, metadata: Optional[Dict[str, Any]]=None) -> None:
        """
    ...
    async def track_state_transition(self, from_state: str, to_state: str, transition_time: float, metadata: Optional[Dict[str, Any]]=None) -> None:
        """
    ...
    async def track_checkpoint(self, checkpoint_id: str, size_bytes: int, save_time: float, metadata: Optional[Dict[str, Any]]=None) -> None:
        """
    ...
    async def track_memory_usage(self, node_name: str, memory_mb: float, metadata: Optional[Dict[str, Any]]=None) -> None:
        """
    ...
    async def track_error(self, error_type: str, node_name: Optional[str]=None, workflow_id: Optional[str]=None, error_details: Optional[Dict[str, Any]]=None) -> None:
        """
    ...
    async def complete_workflow(self, workflow_id: str, status: str, metadata: Optional[Dict[str, Any]]=None) -> None:
        """
    ...
    async def reset_metrics(self) -> None:
        ...
        for tracker in [self.node_tracker, self.workflow_tracker, self.state_tracker, self.checkpoint_metrics, self.memory_tracker, self.error_collector, self.performance_analyzer]:

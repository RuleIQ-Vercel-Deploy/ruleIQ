...
class APIEndpointAnalyzer:
        ...
        try:
            ...
            for method, path, route_pos in route_list:
                ...
                if next_func:
                    ...
                    auth_info = self.analyze_auth_requirements(
                        content, route_pos, func_pos
                    )
                    ...
                    endpoint = {
                        ...
                        "full_path": (
                            f"/api/v1{path}" if not path.startswith("/api") else path
                        ),
                    }
    ...
    def analyze_auth_requirements(
        self, content: str, route_pos: int, func_pos: int
    ) -> Dict:
            ...
            "summary": {
                ...
                "stack_auth_endpoints": len(
                    [
                        e
                        for e in endpoints
                        if e["authentication"]["type"] == "stack_auth"
                    ]
                ),

...
def load_fca_framework() -> Dict[str, Any]:
    ...
    return {
        ...
        "applicable_indu": ["financial_services", "fintech", "banking", "insurance", "investment"],
        "employee_thresh": 1,
        "revenue_thresho": "£0+",
        "geographic_scop": ["UK"],
        "key_requirement": [
...
def load_pci_dss_uk_framework() -> Dict[str, Any]:
    ...
    return {
        "name": "PCI_DSS_UK",
        "display_name": "PCI DSS (UK Implementation)",
        "description": """
        ...
        """,
        "category": "Financial Services",
        "applicable_indu": ["retail", "ecommerce", "financial_services", "hospitality"],
        "employee_thresh": 1,
        "revenue_thresho": "£0+",
        "geographic_scop": ["UK"],
        "key_requirement": [

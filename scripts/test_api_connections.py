...
def test_endpoint(method, endpoint, data=None, headers=None, description=""):
    ...
    try:
        ...
        print(f"{status_symbol} {method} {endpoint} -> {status_code} {description}")
...
def main() -> None:
    ...
    if success and response:
        try:
            ...
            test_endpoint(
                "GET", "/api/v1/assessments/", headers=auth_headers, description="Assessments list"
            )
            test_endpoint(
                "GET", "/api/v1/frameworks/", headers=auth_headers, description="Frameworks list"
            )

        ...
        "chunks": [
            {
                ...
                "command": [
                    ...
                    "-n", "2",  # Limited parallelism for database tests
                    "--dist=worksteal",
                    "-m", "integration",
                    "--tb=short",
                    "--maxfail=5"
            ...
            },
            {
                ...
                "command": [
                    ...
                    "-n", "1",  # Sequential for database integrity
                    "-m", "database",
                    "--tb=short",
                    "--maxfail=5"
                ],
        ...
        "chunks": [
            {
                ...
                "command": [
                    ...
                    "-n", "1",  # Sequential for accurate performance measurement
                    "-m", "performance",
                    "--tb=short",
                    "--maxfail=3",
                    "--benchmark-only",
        ...
        "chunks": [
            {
                ...
                "command": [
                    ...
                    "-n", "1",  # Sequential for E2E integrity
                    "-m", "e2e",
                    "--tb=short",
                    "--maxfail=3"
                ],
    ...
    "chunks": [
        {
            ...
            "command": [
                ...
                "-n", "4",  # Fixed number for CI consistency
                "--dist=worksteal",
...
async def run_chunks_parallel(chunks: List[Dict], max_concurrent: int = 3) -> List[Tuple]:
    ...
    print(f"🖥️  System: {system_info['cpu_count']} CPUs, {system_info['available_memory_gb']:.1f}GB available")
    ...
    if parallel_chunks:
        print(f"🔄 Running {len(parallel_chunks)} chunks in parallel (max {max_concurrent} concurrent)")
        ...
        for name, success, output, duration in results:
            if not success:
                ...
                if output:
                    ...
                    relevant_lines = [l for l in lines[-10:] if 'FAILED' in l or 'ERROR' in l or 'assert' in l]
                    if relevant_lines:
...
async def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Maximum concurrent test chunks"
    )
    parser.add_argument(
        "--list-modes",
        action="store_true",

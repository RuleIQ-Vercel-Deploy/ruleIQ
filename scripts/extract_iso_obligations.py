        ...
        for clause_num, clause_data in standard_data['clauses'].items():
            for control in clause_data['controls']:
                ...
                obligation = {
                    ...
                    'compliance_level': 'mandatory' if control['type'] == 'mandatory' else 'recommended',
...
def main():
    ...
    for framework, summary in framework_summary.items():
        print(f"  - {framework}: {summary['control_count']} controls ({summary['mandatory_count']} mandatory)")

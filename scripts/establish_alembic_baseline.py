...
def main():
    ...
    empty_migration = project_root / "alembic" / "versions" / "cdd9337435cf_initial_empty_migration.py"
    ...
    comprehensive_migration = project_root / "alembic" / "versions" / "802adb6d1be8_add_check_constraint_to_compliance_.py"

...
class ContextMonitor:
    ...
    def _load_config(self) -> Dict:
        ...
        default_config = {
            ...
            "context_triggers": {
                ...
                "frontend": {
                    "patterns": ["frontend/app/**/*.tsx", "frontend/components/**/*.tsx", "frontend/lib/**/*.ts"],
    ...
    def generate_change_report(self, impact_analysis: List[Dict]) -> str:
        ...
        report_lines = [
            f"# Context Change Detection Report",
        ...
        sorted_analysis = sorted(impact_analysis, key=lambda x: impact_order.get(x["impact_level"], 3))
        
        for analysis in sorted_analysis:
            impact_emoji = {"high": "🔴", "medium": "🟡", "low": "🟢"}.get(analysis["impact_level"], "⚪")
    ...
    def run_monitoring_cycle(self) -> str:
        ...
        print(f"🔍 Scanning for context-affecting changes...")
        ...
        print(f"📝 Generating change report...")
    ...
    def _update_change_log(self, impact_analysis: List[Dict]):
        ...
        for analysis in impact_analysis:
            new_entry_lines.extend([
                ...
                f"- **Action Required**: Review and update context documentation",
                ""
            ])

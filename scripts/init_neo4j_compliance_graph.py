...
class ComplianceGraphInitializer:
    ...
    def create_compliance_data(self):
        ...
        with self.driver.session() as session:
            ...
            domains = [
                {"id": "privacy", "name": "Privacy", "description": "Data privacy and protection"},
                {"id": "security", "name": "Security", "description": "Information security and cybersecurity"},
                {"id": "governance", "name": "Governance", "description": "Corporate governance and compliance"},
                {"id": "financial", "name": "Financial", "description": "Financial compliance and reporting"},
                {"id": "operational", "name": "Operational", "description": "Operational compliance and standards"}
            ]
            ...
            regulations = [
                ...
                {"id": "gdpr", "name": "GDPR", "full_name": "General Data Protection Regulation", 
                 "domain": "privacy", "jurisdiction": "eu", "effective_date": "2018-05-25"},
                {"id": "ccpa", "name": "CCPA", "full_name": "California Consumer Privacy Act",
                 "domain": "privacy", "jurisdiction": "us", "effective_date": "2020-01-01"},
                {"id": "hipaa", "name": "HIPAA", "full_name": "Health Insurance Portability and Accountability Act",
                 "domain": "privacy", "jurisdiction": "us", "effective_date": "1996-08-21"},
                
                # Security regulations
                {"id": "iso27001", "name": "ISO 27001", "full_name": "ISO/IEC 27001 Information Security Management",
                 "domain": "security", "jurisdiction": "global", "effective_date": "2013-10-01"},
                {"id": "soc2", "name": "SOC 2", "full_name": "Service Organization Control 2",
                 "domain": "security", "jurisdiction": "us", "effective_date": "2017-01-01"},
                {"id": "pci_dss", "name": "PCI DSS", "full_name": "Payment Card Industry Data Security Standard",
                 "domain": "security", "jurisdiction": "global", "effective_date": "2004-12-01"},
                
                # Financial regulations
                {"id": "sox", "name": "SOX", "full_name": "Sarbanes-Oxley Act",
                 "domain": "financial", "jurisdiction": "us", "effective_date": "2002-07-30"},
                {"id": "mifid2", "name": "MiFID II", "full_name": "Markets in Financial Instruments Directive II",
                 "domain": "financial", "jurisdiction": "eu", "effective_date": "2018-01-03"}
            ]
            ...
            requirements = [
                # GDPR requirements
                {"id": "gdpr_consent", "regulation": "gdpr", "article": "Article 7",
                 "name": "Consent Requirements", "description": "Organizations must obtain freely given, specific, informed consent"},
                {"id": "gdpr_dpo", "regulation": "gdpr", "article": "Article 37",
                 "name": "Data Protection Officer", "description": "Designate a DPO when processing operations require regular monitoring"},
                {"id": "gdpr_breach", "regulation": "gdpr", "article": "Article 33",
                 "name": "Breach Notification", "description": "Notify supervisory authority within 72 hours of breach awareness"},
                
                # ISO 27001 requirements
                {"id": "iso_risk", "regulation": "iso27001", "article": "Clause 6.1",
                 "name": "Risk Assessment", "description": "Identify and assess information security risks"},
                {"id": "iso_access", "regulation": "iso27001", "article": "A.9",
                 "name": "Access Control", "description": "Limit access to information and information processing facilities"},
                
                # SOC 2 requirements
                {"id": "soc2_security", "regulation": "soc2", "article": "CC6",
                 "name": "Security Principle", "description": "Protection against unauthorized access"},
                {"id": "soc2_availability", "regulation": "soc2", "article": "A1",
                 "name": "Availability Principle", "description": "System availability for operation and use"}
            ]
            ...
            controls = [
                {"id": "ctrl_consent_mgmt", "name": "Consent Management System",
                 "type": "Technical", "description": "Automated consent collection and management",
                 "requirements": ["gdpr_consent"]},
                {"id": "ctrl_access_mgmt", "name": "Access Management System",
                 "type": "Technical", "description": "Role-based access control implementation",
                 "requirements": ["iso_access", "soc2_security"]},
                {"id": "ctrl_breach_proc", "name": "Breach Response Procedure",
                 "type": "Administrative", "description": "Documented breach notification process",
                 "requirements": ["gdpr_breach"]},
                {"id": "ctrl_risk_assess", "name": "Risk Assessment Process",
                 "type": "Administrative", "description": "Regular risk assessment and treatment",
                 "requirements": ["iso_risk"]},
                {"id": "ctrl_monitoring", "name": "System Monitoring",
                 "type": "Technical", "description": "24/7 system availability monitoring",
            ...
            metrics = [
                {"id": "metric_consent_rate", "name": "Consent Collection Rate",
                 "type": "Percentage", "target": 100, "control": "ctrl_consent_mgmt"},
                {"id": "metric_breach_time", "name": "Breach Notification Time",
                 "type": "Hours", "target": 72, "control": "ctrl_breach_proc"},
                {"id": "metric_access_review", "name": "Access Review Frequency",
                 "type": "Days", "target": 90, "control": "ctrl_access_mgmt"},
                {"id": "metric_uptime", "name": "System Uptime",
                 "type": "Percentage", "target": 99.9, "control": "ctrl_monitoring"},
                {"id": "metric_risk_review", "name": "Risk Review Frequency",

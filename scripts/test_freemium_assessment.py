...
class FreemiumAssessmentTester:
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                if first_question:
                    ...
                    print(f"   First question: {first_question.get('question_text', 'N/A')[:100]}...")
                    return True
                else:
    ...
    async def test_answer_questions(self) -> bool:
        ...
        for i in range(EXPECTED_MIN_QUESTIONS):
            ...
            # Get current question if we don't have it
            ...
            question_text = self.current_question.get("question_text", "Unknown question")
            print(f"   Q: {question_text[:150]}...")
            
            # Submit answer
            answer_payload = {
                "question_id": self.current_question.get("id", f"q_{i+1}"),
                ...
                if answer_response.status_code == 200:
                    ...
                    if next_question:
                        ...
                        if i < EXPECTED_MIN_QUESTIONS - 1:
                            print(f"   ⚠️ No next question provided (answered: {self.questions_answered})")
                else:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "recommendations" in results:
                    ...
                    print(f"   Recommendations: {len(recs) if isinstance(recs, list) else 'Available'}")

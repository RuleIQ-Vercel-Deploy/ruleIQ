...
class SecretsVaultSetup:
    ...
    def create_production_secrets(self) ->Dict[str, str]:
        ...
        secrets_data = {'database_url':
            ...
            'REPLACE_WITH_ACTUAL_POSTGRES_PASSWORD', 'celery_broker_url':
            'redis://prod-redis.ruleiq.com:6379/3', 'celery_result_backend':
            'redis://prod-redis.ruleiq.com:6379/4', 'backup_s3_bucket':
            'ruleiq-prod-backups'}

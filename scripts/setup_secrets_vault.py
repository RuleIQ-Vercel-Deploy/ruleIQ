...
def main():
    ...
    parser.add_argument(
        "--secret-name", default="ruleiq-production-secrets", help="Secret name"
    )
    ...
    parser.add_argument(
        "--force-delete", action="store_true", help="Force delete secret immediately"
    )
    parser.add_argument(
        "--get", action="store_true", help="Retrieve and display secret"
    )

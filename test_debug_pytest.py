...
@pytest.mark.asyncio
async def test_simple_debug(async_db_session, async_sample_user, async_sample_business_profile):
    ...
    try:
        ...
        # Load golden dataset
        dataset_path = Path(__file__).parent / "tests" / "ai" / "golden_datasets" / "gdpr_questions.json"
